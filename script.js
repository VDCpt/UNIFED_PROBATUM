...
(function initOTSHandshake() {
	...
	window.addEventListener('load', function() {
		if(detectOTSLibrary()) {
			...
			console.info('[UNIFED-OTS] ⚙ Operação em Modo de Segurança Forense — OTS indisponível (CDN bloqueado). ' + 'A funcionalidade OTS/Blockchain estará indisponível; o Nível 2 (PROBATUM interno) permanece ativo.');
		}
	});
})();
// ============================================================================
...
const QUESTIONS_CACHE = [
	...
	{
		id: 1,
		text: "Qual a justificação técnica para o desvio de base tributável (BTOR vs BTF) detetado na triangulação IFDE?",
		type: "critical"
	}, {
		id: 2,
		text: "Disponibilize os 'raw data' (logs de servidor) das transações anteriores ao parsing contabilístico para o período em análise.",
		type: "critical"
	}, {
		id: 3,
		text: "Forneça o 'hash chain' ou prova criptográfica que atesta a imutabilidade dos registos de faturação e logs de acesso para o período em análise.",
		type: "critical"
	}, {
		id: 4,
		text: "Apresente os metadados completos (incluindo 'timestamps' de criação e modificação) de todos os registos de faturação do período para auditoria de integridade temporal.",
		type: "critical"
	}, {
		id: 5,
		text: "Liste todos os acessos de administrador à base de dados que resultaram em alterações de registos financeiros já finalizados, incluindo o 'before' e 'after' dos dados alterados.",
		type: "critical"
	},
	...
	{
		id: 6,
		text: "Como justifica a discrepância de IVA apurado (23% vs 6%) face aos valores declarados no período em análise?",
		type: "high"
	}, {
		id: 7,
		text: "A plataforma disponibiliza o código-fonte do algoritmo de cálculo de comissões para auditoria independente e verificação de conformidade contratual?",
		type: "high"
	}, {
		id: 8,
		text: "Existem registos de 'Shadow Entries' (entradas sem identificador de transação único) no sistema que justifiquem a omissão apurada?",
		type: "high"
	}, {
		id: 9,
		text: "Os extratos bancários dos operadores coincidem com os registos na base de dados da plataforma para o período em análise?",
		type: "high"
	}, {
		id: 10,
		text: "Há evidências de manipulação de 'timestamp' para alterar a validade fiscal das operações registadas?",
		type: "high"
	}, {
		id: 11,
		text: "O sistema permite a edição retroativa de registos de faturação já selados? Como é auditado e quem autorizou as alterações?",
		type: "high"
	}, {
		id: 16,
		text: "Existem fluxos de capital para contas não declaradas na jurisdição nacional que expliquem a diferença entre o BTOR e o BTF?",
		type: "high"
	}, {
		id: 18,
		text: "Como é processada a autoliquidação de IVA em serviços intracomunitários? Porque não foi aplicada no período?",
		type: "high"
	},
	...
	{
		id: 20,
		text: "Qual a justificação técnica para o desvio de base tributável (BTOR vs BTF) detetado na triangulação UNIFED - PROBATUM?",
		type: "critical"
	}, {
		id: 24,
		text: "Há registo de transações em 'offline mode' sem upload posterior? Como foram faturadas e declaradas?",
		type: "high"
	}, {
		id: 27,
		text: "Como é garantida a imutabilidade dos logs de acesso ao sistema financeiro? Apresentar prova técnica.",
		type: "high"
	}, {
		id: 28,
		text: "Os valores reportados à AT via SAF-T PT coincidem com os dados apurados neste relatório? Se não, justificar tecnicamente.",
		type: "high"
	}, {
		id: 30,
		text: "Existe evidência de sub-declaração de receitas via algoritmos de desconto não reportados à autoridade tributária?",
		type: "high"
	}, {
		id: 31,
		text: "É possível inspecionar o código-fonte do módulo de cálculo de taxas variáveis para verificar a sua conformidade com o contrato e a lei?",
		type: "high"
	}, {
		id: 36,
		text: "Identifique e explique a origem de todas as entradas na base de dados que não possuem um identificador de transação único ('Shadow Entries').",
		type: "high"
	}, {
		id: 37,
		text: "Qual o nível de acesso dos administradores à base de dados transacional e quem autorizou as alterações a registos finalizados?",
		type: "high"
	}, {
		id: 40,
		text: "Existe evidência de destruição ou expurgo de registos de auditoria dentro da janela de 6 meses imposta pela plataforma, em violação do Art. 40.º do CIVA?",
		type: "high"
	},
	...
	{
		id: 12,
		text: "Como é determinada a origem geográfica para efeitos de IVA nas transações e qual o impacto na taxa aplicada no período?",
		type: "med"
	}, {
		id: 13,
		text: "Qual o protocolo de redundância quando a API de faturação falha em tempo real? Existem registos de falhas no período em análise?",
		type: "med"
	}, {
		id: 14,
		text: "Como são conciliados os cancelamentos com as faturas retificativas e qual o impacto nas comissões declaradas?",
		type: "med"
	}, {
		id: 15,
		text: "Qual o tratamento contabilístico e fiscal das gorjetas ('Tips') e valores de campanha e porque não foram integralmente considerados na base tributável?",
		type: "med"
	}, {
		id: 17,
		text: "Existe algum 'script' de limpeza automática de logs de erro de sincronização? Apresentar registos completos.",
		type: "med"
	}, {
		id: 19,
		text: "As taxas de intermediação seguem o regime de isenção ou tributação plena? Justificar a opção com referencial normativo.",
		type: "med"
	}, {
		id: 21,
		text: "Existe segregação de funções no acesso aos algoritmos de cálculo financeiro? Quem tem acesso de escrita?",
		type: "med"
	}, {
		id: 22,
		text: "Como são validados os NIFs de clientes em faturas automáticas? Quantos NIFs são inválidos ou omissos no período?",
		type: "med"
	}, {
		id: 23,
		text: "O sistema utiliza 'dark patterns' para ocultar taxas adicionais ao operador? Exemplificar com registos.",
		type: "med"
	}, {
		id: 25,
		text: "Qual a política de retenção de dados brutos antes do parsing contabilístico? Onde estão os originais e por quanto tempo são conservados?",
		type: "med"
	}, {
		id: 26,
		text: "Existem discrepâncias de câmbio não justificadas em faturas multimoeda? Qual o impacto na base tributável?",
		type: "med"
	}, {
		id: 29,
		text: "Qual o impacto da latência da API no valor final cobrado ao cliente e na comissão retida pela plataforma?",
		type: "med"
	}, {
		id: 32,
		text: "Como é que o algoritmo de 'Surge Pricing' interage com a base de cálculo da comissão da plataforma, e existe segregação contabilística destes valores?",
		type: "med"
	}, {
		id: 33,
		text: "Apresente o registo de validação de NIF dos utilizadores para o período em análise, incluindo os que falharam ou foram omitidos.",
		type: "med"
	}, {
		id: 35,
		text: "Como é que o modelo de preços dinâmico ('Surge') impacta a margem bruta reportada e qual a fórmula exata aplicada a cada viagem?",
		type: "med"
	}, {
		id: 38,
		text: "Houve aplicação de taxa de comissão flutuante sem notificação prévia ao utilizador? Qual o algoritmo e base contratual?",
		type: "med"
	}, {
		id: 39,
		text: "Como é que o sistema garante a não-repudiação das faturas emitidas automaticamente? Apresentar mecanismo técnico.",
		type: "med"
	},
	...
	{
		id: 34,
		text: "Demonstre, com logs do sistema, o funcionamento do protocolo de redundância da API de faturação durante as falhas reportadas no período.",
		type: "low"
	}
];
// ============================================================================
...
function robustSAFTParser(csvText) {
	...
	console.log(`✅ EXTRAÇÃO CERTIFICADA v13.1.6-GOLD | ` + `Linhas processadas: ${linhasProcessadas} | Ignoradas: ${linhasIgnoradas} | ` + `Ilíquido: ${formatCurrency(totalIliquido)} | ` + `IVA: ${formatCurrency(totalIVA)} | ` + `Bruto: ${formatCurrency(totalBruto)}`);
	logAudit(`📋 SAF-T Extraído v13.1.6-GOLD (Header-Mapping) — ` + `Linhas: ${linhasProcessadas} | ` + `Ilíquido: ${formatCurrency(totalIliquido)} | ` + `IVA: ${formatCurrency(totalIVA)} | ` + `Bruto: ${formatCurrency(totalBruto)}`, 'success');
...
const getRiskVerdict = (delta, gross) => {
	if(gross === 0 || isNaN(gross)) return {
		...
		color: '#8c7ae6',
		description: {
			pt: 'Dados insuficientes para veredicto pericial.',
			en: 'Insufficient data for expert verdict.'
		},
		percent: '0.00%'
	};
	const pct = Math.abs((delta / gross) * 100);
	const pctFormatted = pct.toLocaleString('pt-PT', {
		minimumFractionDigits: 2,
		maximumFractionDigits: 2
	}) + '%';
	if(pct <= 3) return {
		...
		color: '#44bd32',
		description: {
			pt: 'Margem de erro operacional. Discrepâncias dentro dos limites aceitáveis.',
			en: 'Operational error margin. Discrepancies within acceptable limits.'
		},
	...
	if(pct <= 10) return {
		...
		color: '#f59e0b',
		description: {
			pt: 'Anomalia algorítmica detetada. Recomenda-se auditoria aprofundada.',
			en: 'Algorithmic anomaly detected. In-depth audit recommended.'
		},
		percent: pctFormatted
	};
	if(pct <= 25) return {
	...
	return {
		level: {
			pt: 'RISCO CRÍTICO · INFRAÇÃO DETETADA',
			en: 'CRITICAL RISK · INFRACTION DETECTED'
		},
		key: 'critical',
		color: '#ff0000',
		description: {
...
const generateSessionId = () => {
	return 'UNIFED-' + Date.now().toString(36).toUpperCase() + '-' + Math.random().toString(36).substring(2, 7).toUpperCase();
};
...
async function generateForensicLog(action, fileName, hash) {
	const finalHash = (hash && hash.length === 64) ? hash.toUpperCase() : await generateForensicHash(fileName + Date.now());
	...
	console.log('%c[UNIFED-CUSTODY] ' + action + ' · ' + fileName, 'color:#00e5ff;font-family:monospace;font-weight:bold;');
	console.log('%c  SHA-256: ' + finalHash, 'color:#4ade80;font-family:monospace;font-size:0.85em;');
	console.log('%c  ' + seal.tsaLevel + ' · ' + seal.genTime + ' [S/N: ' + seal.serialNumber + ']', 'color:#94a3b8;font-family:monospace;font-size:0.8em;');
	return entry;
}
...
function showBlockchainExplain(hash) {
	...
	el.style.cssText = ['position:fixed;bottom:2rem;right:2rem;z-index:999999;', 'background:#0a0f1e;border:1px solid #00e5ff;border-radius:4px;', 'padding:1.4rem 1.6rem;max-width:420px;', 'font-family:"JetBrains Mono",monospace;font-size:0.72rem;', 'color:#cbd5e1;box-shadow:0 0 30px rgba(0,229,255,0.15);', 'animation:custodyFadeIn 0.3s ease;'].join('');
	el.innerHTML = `
...
function renderCustodyLog(logs) {
	...
	sorted.forEach(function(entry) {
		...
		bodyDiv.innerHTML = '<p><strong>EVENTO:</strong> ' + escapeHtml(entry.action) + '</p>' + '<p><strong>FICHEIRO:</strong> <span style="color:#e2b87a;">' + escapeHtml(fname) + '</span></p>' + '<p><strong>TIMESTAMP:</strong> ' + escapeHtml(ts) + '</p>';
		if(hasHash) {
		...
		bodyDiv.innerHTML += '<p><strong>FONTE:</strong> ' + escapeHtml(source) + '</p>' + '<p><strong>NÍVEL:</strong> ' + escapeHtml(level) + '</p>';
		...
		reader.onload = function(e) {
			try {
				...
				for(let i = 1; i < lines.length; i++) {
					...
					const existing = UNIFEDSystem.analysis.evidenceIntegrity.find(ev => ev.hash && ev.hash.toLowerCase() === entry.hash.toLowerCase());
					if(existing) {
				...
				logAudit(`✅ CSV de Controlo importado: ${importedEntries.length} entradas ` + `(${matchCount} correspondidas, ${newCount} novas).`, 'success');
...
async function submitToOpenTimestamps() {
	...
	if(!OTS) {
		...
		const stubBlob = new Blob([stubData], {
			type: 'application/json'
		});
	...
	try {
		...
		const calendarUrls = ['https://alice.btc.calendar.opentimestamps.org', 'https://bob.btc.calendar.opentimestamps.org', 'https://finney.calendar.eternitywall.com'];
...
function _showOTSSuccessModal(filename, masterHash, isPendingStub = false, upgradeStatus = '') {
	...
	const titleText = isPendingStub ? '⏳ REGISTO LOCAL — SUBMISSÃO PENDENTE' : isConfirmed ? '🔗 ANCORAGEM BLOCKCHAIN CONFIRMADA (MERKLE PROOF)' : '🛡️ ANCORAGEM BLOCKCHAIN EFETUADA';
	const subtitleText = isPendingStub ? 'STUB LOCAL · HASH REAL · RE-SUBMETER EM PRODUÇÃO' : isConfirmed ? 'BITCOIN MERKLE PROOF · INVIABILIDADE DE ALTERAÇÃO RETROATIVA · PROVA DE NÃO-REPÚDIO' : 'OPENTIMESTAMPS · CALENDAR ATTESTATION · ISO/IEC 27037:2012';
	const bodyText = isPendingStub ? `O nó OpenTimestamps não estava acessível. Um ficheiro stub foi gerado com o hash real e o timestamp da tentativa.
           Em ambiente de produção, re-submeter o ficheiro <code style="color:#00e5ff;">.ots</code> gerado ao calendário OTS para obter a prova Bitcoin completa.` : isConfirmed ? `O Master Hash SHA-256 desta perícia está ancorado na <strong style="color:#f59e0b;">Bitcoin blockchain</strong> com prova Merkle completa.
               ...
               Guarde o ficheiro <code style="color:#00e5ff;">.ots</code> — ele é a sua prova definitiva de existência temporal imutável.` : `O Master Hash SHA-256 desta perícia foi submetido e aceite pelos Calendários Remotos OpenTimestamps.
	...
	const statusBadge = isPendingStub ? `<span style="color:#94a3b8;">⏳ STUB LOCAL</span>` : isConfirmed ? `<span style="color:#4ade80;font-weight:700;">✔ BITCOIN MERKLE PROOF (CONFIRMADO)</span>` : `<span style="color:#f59e0b;font-weight:700;">⏱ CALENDAR ATTESTATION (CONFIRMAÇÃO BITCOIN ~1h)</span>`;
	const overlay = document.createElement('div');
	overlay.id = 'otsSuccessModal';
	overlay.style.cssText = ['position:fixed;inset:0;z-index:999997;', 'background:rgba(0,0,0,0.9);backdrop-filter:blur(10px);', 'display:flex;align-items:center;justify-content:center;padding:2rem;'].join('');
	overlay.innerHTML = `
...
function _loadAndValidateTSR(masterHash) {
	...
	input.onchange = async (e) => {
		...
		try {
			...
			UNIFEDSystem.forensicMetadata.nivel2Seal = Object.assign(UNIFEDSystem.forensicMetadata.nivel2Seal || {}, {
...
async function _doOnlineSeal(masterHash) {
	...
	try {
		...
		const tokenSim = 'UNIFED-NIVEL1-' + Date.now().toString(36).toUpperCase() + '-' + Math.random().toString(36).substr(2, 8).toUpperCase();
...
function _showNivel2Modal(tsaDate, tsaProvider) {
	...
	overlay.style.cssText = ['position:fixed;inset:0;z-index:999998;', 'background:rgba(0,0,0,0.88);backdrop-filter:blur(8px);', 'display:flex;align-items:center;justify-content:center;padding:2rem;'].join('');
	overlay.innerHTML = `
...
const ForensicLogger = {
	...
	addEntry(action, data = {}) {
		const entry = {
			...
			data: data,
			ip: 'local',
			userAgent: /Chrome/i.test(navigator.userAgent) ? 'Browser::Chromium-family' : /Firefox/i.test(navigator.userAgent) ? 'Browser::Firefox-family' : /Safari/i.test(navigator.userAgent) ? 'Browser::Safari-family' : /Edge/i.test(navigator.userAgent) ? 'Browser::Edge-family' : 'Browser::Unknown'
		};
	...
	exportMonthly(yearMonth) {
		const filtered = yearMonth ? this.logs.filter(l => l.timestamp && l.timestamp.startsWith(yearMonth)) : this.logs;
		const exportPayload = {
	...
	clearLogs() {
		...
		this.addEntry('SYSTEM_LOGS_CLEARED', {
			action: 'Logs purgados pelo operador',
	...
	renderLogsToElement(elementId) {
		...
		logsToShow.forEach(log => {
			...
			const date = new Date(log.timestamp).toLocaleString(typeof currentLang !== 'undefined' && currentLang === 'pt' ? 'pt-PT' : 'en-GB');
	...
	_getSecret() {
		...
		try {
			...
			if(_storedId && _storedStart) {
				...
				_sessionId = (typeof UNIFEDSystem !== 'undefined' && UNIFEDSystem.sessionId) ? UNIFEDSystem.sessionId : 'UNIFED-DIAMOND-PROBATUM-PRESESSION';
				_sessionStart = (typeof UNIFEDSystem !== 'undefined' && UNIFEDSystem._sessionStart) ? String(UNIFEDSystem._sessionStart) : String(Math.floor(Date.now() / 86400000));
	...
	getFormattedAuditTrail() {
		...
		return logs.map(l => `[${l.timestamp}] ${String(l.action || '').toUpperCase()}: ${JSON.stringify(l.data || {})}`).join('\n');
	}
};
// ============================================================================
...
const ValueSource = {
	...
	registerValue(elementId, value, sourceFile, calculationMethod = 'extração dinâmica') {
		...
		ForensicLogger.addEntry('VALUE_REGISTERED', {
			elementId,
			value,
			sourceFile
		});
...
function switchLanguage() {
	...
	ForensicLogger.addEntry('LANGUAGE_CHANGED', {
		lang: currentLang
	});
...
const SchemaRegistry = {
	schemas: {
		statement: {
			...
			patterns: {
				ganhosLiquidosTable: [/Ganhos\s*([\d\s,.]+)\s*Despesas\s*-?\s*([\d\s,.]+)\s*Ganhos\s*líquidos\s*([\d\s,.]+)/is, /Ganhos\s*([\d\s,.]+)\s*Despesas\s*-?\s*([\d\s,.]+)\s*Ganhos\s*líquidos\s*([\d\s,.]+)/i, /Ganhos\s+([\d\s,.]+)\s*€?\s*Despesas\s*-?\s*([\d\s,.]+)\s*€?\s*Ganhos\s*líquidos\s*([\d\s,.]+)\s*€?/i],
				ganhos: [/Ganhos\s*([\d\s,.]+)\s*€/i, /Total\s+de\s+Ganhos\s*[:\s]*([\d\s,.]+)/i],
				despesas: [/Despesas\s*-?\s*([\d\s,.]+)\s*€/i, /Total\s+de\s+Despesas\s*[:\s]*([\d\s,.]+)/i],
				ganhosLiquidos: [/Ganhos\s*líquidos\s*([\d\s,.]+)\s*€/i, /Valor\s+líquido\s+creditado\s*[:\s]*([\d\s,.]+)/i]
			}
		},
		invoice: {
			name: 'Fatura',
			patterns: {
				valorTotal: [/Total com IVA\s*\(EUR\)\s*([\d\s,.]+)/i, /Total a pagar\s*([\d\s,.]+)/i, /Valor total\s*([\d\s,.]+)/i, /Invoice total\s*[:\s]*([\d\s,.]+)/i, /Amount due\s*[:\s]*([\d\s,.]+)/i, /Total\s*[:\s]*([\d\s,.]+)\s*€/i],
				valorSemIVA: [/Total sem IVA\s*([\d\s,.]+)/i, /Subtotal\s*[:\s]*([\d\s,.]+)/i],
				iva: [/IVA\s*\(23%\)\s*([\d\s,.]+)/i, /VAT\s*[:\s]*([\d\s,.]+)/i]
			},
			tablePatterns: [/Comissões da Bolt.*?(\d+\.\d+).*?(\d+\.\d+).*?(\d+\.\d+).*?(\d+\.\d+)/is]
		},
		dac7: {
			name: 'Declaração DAC7',
			patterns: {
				receitaAnual: [/Total de receitas anuais:\s*€?\s*([\d\s,.]+)/i, /Annual revenue total:\s*€?\s*([\d\s,.]+)/i, /Total income\s*[:\s]*€?\s*([\d\s,.]+)/i],
				receitaQ1: [/Ganhos do 1\.º trimestre:\s*€?\s*([\d\s,.]+)/i, /1\.º trimestre:\s*€?\s*([\d\s,.]+)/i, /1st quarter:\s*€?\s*([\d\s,.]+)/i, /Q1 revenue\s*[:\s]*€?\s*([\d\s,.]+)/i],
				receitaQ2: [/Ganhos do 2\.º trimestre:\s*€?\s*([\d\s,.]+)/i, /2\.º trimestre:\s*€?\s*([\d\s,.]+)/i, /2nd quarter:\s*€?\s*([\d\s,.]+)/i, /Q2 revenue\s*[:\s]*€?\s*([\d\s,.]+)/i],
				receitaQ3: [/Ganhos do 3\.º trimestre:\s*€?\s*([\d\s,.]+)/i, /3\.º trimestre:\s*€?\s*([\d\s,.]+)/i, /3rd quarter:\s*€?\s*([\d\s,.]+)/i, /Q3 revenue\s*[:\s]*€?\s*([\d\s,.]+)/i],
				receitaQ4: [/Ganhos do 4\.º trimestre:\s*€?\s*([\d\s,.]+)/i, /4\.º trimestre:\s*€?\s*([\d\s,.]+)/i, /4th quarter earnings:\s*€?\s*([\d\s,.]+)/i, /Q4 revenue\s*[:\s]*€?\s*([\d\s,.]+)/i, /Fourth quarter\s*[:\s]*€?\s*([\d\s,.]+)/i]
			}
		},
		saft: {
			name: 'SAF-T',
	...
	processDAC7(text, filename, periodoSelecionado) {
		...
		const extractDAC7Value = (label, txt) => {
			const re = new RegExp(label.replace(/[.*+?^${}()|[\]\\]/g, '\\$&') + '[:\s]*(?:€\s*)?([\d][\d\s.,]*(?:[.,]\d{1,2})?\s*€?)', 'i');
			const m = txt.match(re);
			if(m && m[1]) {
				const val = normalizeNumericValue(m[1]);
				if(val > 0) return val;
			}
			const reLine = new RegExp(label.replace(/[.*+?^${}()|[\]\\]/g, '\\$&') + '[^\n]*?(€?\s*[\d][\d\s.,]{0,20})', 'i');
		...
		logAudit(`📊 Extração DAC7 v13.1.6-GOLD (${periodoSelecionado}) — ` + `Q1: ${formatCurrency(result.q1)} | Q2: ${formatCurrency(result.q2)} | ` + `Q3: ${formatCurrency(result.q3)} | Q4: ${formatCurrency(result.q4)}`, 'info');
		return result;
	},
...
function forensicDataSynchronization() {
	...
	const statementFiles = UNIFEDSystem.analysis.evidenceIntegrity.filter(item => item.type === 'statement').length;
	const invoiceFiles = UNIFEDSystem.analysis.evidenceIntegrity.filter(item => item.type === 'invoice').length;
	const controlFiles = UNIFEDSystem.analysis.evidenceIntegrity.filter(item => item.type === 'control').length;
	const saftFiles = UNIFEDSystem.analysis.evidenceIntegrity.filter(item => item.type === 'saft').length;
	const dac7Files = UNIFEDSystem.analysis.evidenceIntegrity.filter(item => item.type === 'dac7').length;
	if(UNIFEDSystem.documents.statements) {
		UNIFEDSystem.documents.statements.files = UNIFEDSystem.analysis.evidenceIntegrity.filter(item => item.type === 'statement').map(item => ({
			name: item.filename,
			size: item.size
		}));
	...
	if(UNIFEDSystem.documents.invoices) {
		UNIFEDSystem.documents.invoices.files = UNIFEDSystem.analysis.evidenceIntegrity.filter(item => item.type === 'invoice').map(item => ({
			name: item.filename,
			size: item.size
		}));
	...
	ForensicLogger.addEntry('SYNC_COMPLETED', {
		total,
		controlFiles,
		saftFiles,
		invoiceFiles,
...
document.addEventListener('DOMContentLoaded', () => {
	...
	ForensicLogger.addEntry('SYSTEM_START', {
		...
		logsCarregados: ForensicLogger.logs.length
	});
});
...
function startGatekeeperSession() {
	ForensicLogger.addEntry('SESSION_START', {
		from: 'splash'
	});
	...
	if(typeof generateQRCode === 'function') generateQRCode();
	ForensicLogger.addEntry('SESSION_CREATED', {
	...
	try {
		...
		if(stored) {
			...
			if(client && client.name && client.nif) {
				...
				ForensicLogger.addEntry('CLIENT_RESTORED', {
					name: client.name,
					nif: client.nif
				});
			}
...
function setupMainListeners() {
	...
	if(anoFiscal) {
		anoFiscal.addEventListener('change', (e) => {
			...
			ForensicLogger.addEntry('YEAR_CHANGED', {
				year: e.target.value
			});
		});
	}
	...
	if(periodoAnalise) {
		...
		periodoAnalise.addEventListener('change', (e) => {
			...
			ForensicLogger.addEntry('PERIOD_CHANGED', {
	...
	if(selPlatform) {
		selPlatform.addEventListener('change', (e) => {
			...
			ForensicLogger.addEntry('PLATFORM_CHANGED', {
...
function handleDrop(e) {
	...
	ForensicLogger.addEntry('FILES_DROPPED', {
		count: files.length
	});
}
...
function handleGlobalFileSelect(e) {
	...
	processBatchFiles(files);
	ForensicLogger.addEntry('FILES_SELECTED', {
		count: files.length
	});
	e.target.value = '';
}
...
async function processBatchFiles(files) {
	...
	ForensicLogger.addEntry('BATCH_PROCESSING_START', {
		count: files.length
	});
...
async function processQueue() {
	...
	while(fileProcessingQueue.length > 0) {
		...
		try {
			...
			ForensicLogger.addEntry('FILE_PROCESSING_ERROR', {
				filename: file.name,
				error: error.message
			});
		}
	...
	ForensicLogger.addEntry('BATCH_PROCESSING_COMPLETE', {
		total
	});
	updateEvidenceSummary();
	updateCounters();
...
async function detectFileType(file) {
	...
	if(name.includes('fatura') || name.includes('invoice') || name.match(/pt\d{4}-\d{5}/i) || name.match(/pt\d{4,5}-\d{3,5}/i) || (file.type === 'application/pdf' && name.match(/\d{4}-\d{5}/))) {
		return 'invoice';
	}
	if(name.match(/131509.*\.csv$/) || name.includes('saf-t') || name.includes('saft')) {
		return 'saft';
	}
	if(name.includes('extrato') || name.includes('statement') || name.includes('ganhos') || name.includes('earnings')) {
		return 'statement';
	}
	...
	if(file.type === 'application/pdf' || name.endsWith('.pdf')) {
		try {
			...
			if(text.includes('dac7') || (text.includes('ganhos') && text.includes('trimestre')) || (text.includes('earnings') && text.includes('quarter'))) {
				return 'dac7';
			}
...
function registerClient() {
	...
	ForensicLogger.addEntry('CLIENT_REGISTERED', {
		name,
		nif
	});
...
async function processFile(file, type) {
	...
	ForensicLogger.addEntry('FILE_PROCESSING_START', {
		filename: file.name,
		type
	});
	let text = "";
	...
	if(isPDF) {
		try {
			...
			text = fullText.replace(/[\u0000-\u0008\u000B\u000C\u000E-\u001F\u007F-\u009F]/g, ' ').replace(/\s+/g, ' ').replace(/[–—−]/g, '-').replace(/(\d)[\s\n\r]+(\d)/g, '$1$2').replace(/[""]/g, '"').replace(/''/g, "'");
			...
			ForensicLogger.addEntry('PDF_PROCESSING_ERROR', {
				filename: file.name,
	...
	const fileExists = UNIFEDSystem.documents[type].files.some(f => `${f.name}_${f.size}_${f.lastModified}` === fileEntryKey);
	if(!fileExists) {
		...
		try {
			...
			if(yearMonth) {
				if(!UNIFEDSystem.monthlyData[yearMonth]) {
					UNIFEDSystem.monthlyData[yearMonth] = {
						ganhos: 0,
						despesas: 0,
						ganhosLiq: 0
					};
			...
			ForensicLogger.addEntry('STATEMENT_PROCESSED', {
				filename: file.name,
				...extracted
			});
		} catch (e) {
			...
			ForensicLogger.addEntry('STATEMENT_PROCESSING_ERROR', {
				filename: file.name,
				error: e.message
			});
		}
		...
		try {
			...
			if(extracted.valorTotal > 0) {
				if(!UNIFEDSystem.documents.invoices.totals) {
					UNIFEDSystem.documents.invoices.totals = {
						invoiceValue: 0,
						records: 0
					};
				}
				...
				ForensicLogger.addEntry('INVOICE_PROCESSED', {
					filename: file.name,
					valor: extracted.valorTotal
				});
			} else {
			...
			ForensicLogger.addEntry('INVOICE_PROCESSING_ERROR', {
				filename: file.name,
				error: e.message
			});
		}
	...
	if(type === 'saft' && file.name.match(/131509.*\.csv$/i)) {
		try {
			...
			if(!UNIFEDSystem.documents.saft.totals) {
				UNIFEDSystem.documents.saft.totals = {
					records: 0,
					iliquido: 0,
					iva: 0,
					bruto: 0
			...
			ForensicLogger.addEntry('SAFT_PROCESSED', {
				filename: file.name,
				total: extracted.totalBruto,
				iva: extracted.totalIVA,
				iliquido: extracted.totalIliquido
			});
		} catch (e) {
			console.warn(`Erro ao processar SAF-T ${file.name}:`, e);
			logAudit(`[!] Erro no processamento SAF-T: ${e.message}`, 'warning');
			ForensicLogger.addEntry('SAFT_PROCESSING_ERROR', {
				filename: file.name,
				error: e.message
			});
		}
	...
	if(type === 'dac7') {
		try {
			...
			ForensicLogger.addEntry('DAC7_PROCESSED', {
				filename: file.name,
				q1: extracted.q1,
				q2: extracted.q2,
				q3: extracted.q3,
	...
	if(type === 'control') {
		...
		ForensicLogger.addEntry('CONTROL_FILE_ADDED', {
			filename: file.name
		});
	}
...
function getListIdForType(type) {
	switch(type) {
		case 'invoice':
			return 'invoicesFileListModal';
		case 'statement':
			return 'statementsFileListModal';
		case 'dac7':
			return 'dac7FileListModal';
		case 'control':
			return 'controlFileListModal';
		case 'saft':
			return 'saftFileListModal';
		default:
			return 'globalFileListModal';
	}
}
...
function simulateUpload(type, count) {
	...
	for(let i = 0; i < count; i++) {
		...
		const fileExists = UNIFEDSystem.documents[type].files.some(f => `${f.name}_${f.size}_${f.lastModified || 0}` === simFileKey);
		if(!fileExists) {
		...
		const normalizedType = type === 'invoices' ? 'invoice' : type === 'statements' ? 'statement' : type;
		UNIFEDSystem.analysis.evidenceIntegrity.push({
			filename: fileName,
			type: normalizedType,
			hash: demoHashForPDF,
...
function performAudit() {
	...
	if(!hasFiles) {
		ForensicLogger.addEntry('AUDIT_FAILED', {
			reason: 'No files'
		});
	...
	setTimeout(() => {
		try {
			...
			switch(UNIFEDSystem.selectedPeriodo) {
				...
				case 'trimestral':
					dac7TotalPeriodo = dac7Q1 + dac7Q2 + dac7Q3 + dac7Q4;
					if((dac7Q1 > 0 && (dac7Q2 > 0 || dac7Q3 > 0 || dac7Q4 > 0)) || (dac7Q2 > 0 && (dac7Q3 > 0 || dac7Q4 > 0)) || (dac7Q3 > 0 && dac7Q4 > 0)) {
			...
			ForensicLogger.addEntry('AUDIT_ERROR', {
				error: error.message
			});
...
function performForensicCrossings() {
	...
	cross.c4_pct = cross.c4_liquidoDeclarado > 0 ? (cross.c4_delta / cross.c4_liquidoDeclarado) * 100 : 0;
	...
	if(UNIFEDSystem.analysis.verdict) {
		UNIFEDSystem.analysis.verdict.percent = cross.percentagemDiscrepancia.toLocaleString('pt-PT', {
			minimumFractionDigits: 2,
			maximumFractionDigits: 2
		}) + '%';
	}
	...
	ForensicLogger.addEntry('CROSSINGS_CALCULATED_4AXES', {
		c1_saftVsDac7: {
			delta: cross.c1_delta,
			pct: cross.c1_pct
		},
		c2_despVsFatura: {
			delta: cross.c2_delta,
			pct: cross.c2_pct
		},
		c3_saftVsGanhos: {
			delta: cross.c3_delta,
			pct: cross.c3_pct
		},
		c4_liqDecVsReal: {
			delta: cross.c4_delta,
			pct: cross.c4_pct
		},
...
function selectQuestions(riskKey) {
	...
	ForensicLogger.addEntry('QUESTIONS_SELECTED', {
		count: UNIFEDSystem.analysis.selectedQuestions.length,
		riskKey
	});
}
...
function filterDAC7ByPeriod() {
	...
	ForensicLogger.addEntry('DAC7_PERIOD_FILTER', {
		periodo,
		visible,
		periodoTotal
	});
...
function showTwoAxisAlerts() {
	...
	if(omissaoCard && omissaoValue) {
		...
		if(ganhos > 0 && despesas > 0) {
			...
			omissaoValue.textContent = pct.toLocaleString(currentLang === 'en' ? 'en-GB' : 'pt-PT', {
				minimumFractionDigits: 2,
				maximumFractionDigits: 2
			}) + ' %';
			if(omissaoDesc) {
				omissaoDesc.textContent = currentLang === 'en' ? `(${formatCurrency(despesas)} / ${formatCurrency(ganhos)}) × 100  [Expenses/Commissions / Earnings]` : `(${formatCurrency(despesas)} / ${formatCurrency(ganhos)}) × 100  [Despesas/Comissões / Ganhos]`;
			}
			if(pct > 25) {
...
function updateDashboard() {
	...
	if(quantumFormulaEl) {
		quantumFormulaEl.textContent = currentLang === 'en' ? `Base Differential Under Analysis (Expenses/Commissions vs Invoice): ${formatCurrency(cross.discrepanciaCritica)} | ${cross.percentagemOmissao.toFixed(2)}%` : `Diferencial de Base em Análise (Despesas/Comissões vs Fatura): ${formatCurrency(cross.discrepanciaCritica)} | ${cross.percentagemOmissao.toFixed(2)}%`;
	}
	const quantumNoteEl = document.getElementById('quantumNote');
	if(quantumNoteEl) {
		quantumNoteEl.textContent = currentLang === 'en' ? `VAT 23%: ${formatCurrency(cross.ivaFalta)} | VAT 6%: ${formatCurrency(cross.ivaFalta6)} | SAF-T/DAC7: ${formatCurrency(cross.discrepanciaSaftVsDac7)}` : `IVA 23%: ${formatCurrency(cross.ivaFalta)} | IVA 6%: ${formatCurrency(cross.ivaFalta6)} | SAF-T/DAC7: ${formatCurrency(cross.discrepanciaSaftVsDac7)}`;
	}
...
function renderChart() {
	...
	const labels = [
		...
		t.kpiInvText || 'Faturado', `DAC7 ${periodoTexto}`
	];
	const data = [
		totals.saftBruto || 0,
		totals.ganhos || 0,
	...
	UNIFEDSystem.discrepancyChart = new Chart(ctx, {
		...
		data: {
			datasets: [{
				...
				data: [{
					x: 2,
					y: cross.discrepanciaSaftVsDac7
				}],
...
async function exportDataJSON() {
	...
	ForensicLogger.addEntry('JSON_EXPORT_COMPLETED', {
		sessionId: UNIFEDSystem.sessionId
	});
}
// ============================================================================
...
async function exportPDF() {
	...
	try {
		...
		const twoAxis = UNIFEDSystem.analysis.twoAxis;
		const cross = UNIFEDSystem.analysis.crossings;
		const verdict = UNIFEDSystem.analysis.verdict || {
			level: {
				pt: 'N/A',
				en: 'N/A'
			},
			...
			color: '#8c7ae6',
			description: {
				pt: 'Perícia não executada.',
				en: 'Forensic exam not executed.'
			},
			percent: '0.00%'
		};
		let pageNumber = 1;
		...
		const _pctReceita = totals.ganhos > 0 ? ((cross.discrepanciaSaftVsDac7 / totals.ganhos) * 100) : 0;
		const _pctReceitaStr = _pctReceita.toFixed(2) + '%';
		const _impactoMercado7Anos = (cross.impactoSeteAnosMercado && cross.impactoSeteAnosMercado > 0) ? cross.impactoSeteAnosMercado : forensicRound(cross.discrepanciaCritica * 12 * 38000 * 7);
		...
		const addWatermark = (doc) => {
			...
			doc.text('PROVA DIGITAL MATERIAL', pageWidth / 2, pageHeight / 2, {
				align: 'center',
				angle: 45
			});
		...
		const addFooter = (doc, pageNum, isLastPage = false) => {
			...
			const margin = 14;
			addWatermark(doc);
			const _afsId = (typeof window.activeForensicSession !== 'undefined' && window.activeForensicSession.sessionId) ? window.activeForensicSession.sessionId : (UNIFEDSystem.sessionId || 'UNIFED-MMLADX8Q-CV69L');
			const sessionLabel = `SESSÃO: ${_afsId}`;
			doc.setFontSize(6);
			doc.setFont('courier', 'normal');
			doc.setTextColor(120, 120, 120);
			doc.text(sessionLabel, pageWidth - margin, 8, {
				align: 'right'
			});
			const _mhFull = (typeof window.activeForensicSession !== 'undefined' && window.activeForensicSession.masterHash) ? window.activeForensicSession.masterHash : (UNIFEDSystem.masterHash || '');
			if(_mhFull) {
				...
				doc.text(`Pág. ${pageNum} · UNIFED-PROBATUM v13.5.0-PURE · ISO/IEC 27037:2012 · Art. 125.º CPP`, pageWidth / 2, pageHeight - 8, {
					align: 'center'
				});
			}
			...
			if(_qrDataUrl && !isLastPage) {
				...
				doc.text('PROBATUM', _qrMiniX + _qrMiniSize / 2, _qrMiniY + _qrMiniSize + 2, {
					align: 'center'
				});
			}
			if(isLastPage) {
				...
				doc.text('PROBATUM SEAL v13.5.0-PURE', sealX + boxSize / 2, sealY + 3.5, {
					align: 'center'
				});
				if(_qrDataUrl) {
					doc.addImage(_qrDataUrl, 'PNG', sealX + qrMargin + 2, sealY + 5, qrSize, qrSize);
					console.log('[UNIFED-PDF] ✅ QR Code inserido no PDF (sincronamente).');
				} else {
					doc.setFontSize(4);
					doc.setFont('courier', 'normal');
					doc.setTextColor(180, 180, 180);
					doc.text('[QR CODE INDISPONÍVEL]', sealX + boxSize / 2, sealY + qrSize / 2 + 5, {
						align: 'center'
					});
				}
				doc.setFontSize(4.2);
				...
				doc.text(certLine1, sealX + boxSize / 2, sealY + qrSize + 7, {
					align: 'center'
				});
				doc.text(certLine2, sealX + boxSize / 2, sealY + qrSize + 10, {
					align: 'center'
				});
				doc.setFont('courier', 'normal');
				doc.setFontSize(3.8);
				doc.setTextColor(80, 80, 80);
				doc.text(certLine3, sealX + boxSize / 2, sealY + qrSize + 13, {
					align: 'center'
				});
				doc.text(certLine4, sealX + boxSize / 2, sealY + qrSize + 16, {
					align: 'center'
				});
				doc.setFontSize(3.5);
				doc.setTextColor(120, 120, 120);
				doc.text('Uso restrito a mandato jurídico autorizado', sealX + boxSize / 2, sealY + qrSize + 19, {
					align: 'center'
				});
		...
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(0, 0, 0);
		doc.text('UNIFED - PROBATUM | UNIDADE DE PERÍCIA FISCAL E DIGITAL', doc.internal.pageSize.getWidth() / 2, 20, {
			align: 'center'
		});
		doc.setFontSize(8);
		doc.setFont('helvetica', 'normal');
		doc.text('ESTRUTURA DE PARECER TÉCNICO FORENSE MOD. 03-B (NORMA ISO/IEC 27037)', doc.internal.pageSize.getWidth() / 2, 28, {
			align: 'center'
		});
		doc.setDrawColor(0, 0, 0);
		doc.setLineWidth(1);
		...
		doc.setFontSize(9);
		doc.setFont('courier', 'bold');
		doc.text('CONFIDENCIAL', doc.internal.pageSize.getWidth() - left, y - 10, {
			align: 'right'
		});
		doc.setFont('courier', 'normal');
		doc.text('Cadeia de Custódia Forense: Ativa', doc.internal.pageSize.getWidth() - left, y - 5, {
			align: 'right'
		});
		...
		doc.text(`PROCESSO N.º: ${_pdfSessionId}`, left, y, {
			lineHeightFactor: 1.5
		});
		y += 5;
		doc.text(`DATA: ${new Date().toLocaleDateString('pt-PT')}`, left, y, {
			lineHeightFactor: 1.5
		});
		y += 5;
		doc.text(`OBJETO: RECONSTITUIÇÃO DA VERDADE MATERIAL DIGITAL / ART. 103.º RGIT`, left, y, {
			lineHeightFactor: 1.5
		});
		y += 4;
		...
		doc.setFontSize(7.5);
		doc.setTextColor(80, 80, 80);
		const _notaLines = doc.splitTextToSize('[ Nota: Este sistema não realiza contabilidade — realiza RECONSTITUIÇÃO DA VERDADE MATERIAL DIGITAL ' + '(Art. 125.º CPP · ISO/IEC 27037:2012) ]', doc.internal.pageSize.getWidth() - left - 10);
		doc.text(_notaLines, left, y, {
			lineHeightFactor: 1.5
		});
		y += (_notaLines.length * 4.5) + 2;
		doc.setFont('courier', 'normal');
		doc.setFontSize(9);
		doc.setTextColor(0, 0, 0);
		...
		doc.setFontSize(10);
		doc.setFont('helvetica', 'bold');
		doc.text('PROTOCOLO DE CADEIA DE CUSTÓDIA', left, y);
		y += 6;
		doc.setFontSize(8);
		doc.setFont('helvetica', 'normal');
		doc.text('O sistema UNIFED - PROBATUM assegura a inviolabilidade dos dados atraves de funcoes criptograficas SHA-256. As', left, y);
		y += 4;
		doc.text('seguintes evidências foram processadas e incorporadas na análise, garantindo a rastreabilidade total da prova:', left, y);
		y += 6;
		...
		evidenceList.forEach((item, index) => {
			...
			doc.text(`${index + 1}. ${item.filename} - Hash: ${shortHash}`, left, y);
			y += 4;
		});
		y += 6;
		doc.setFont('helvetica', 'bold');
		doc.text('INVIOLABILIDADE DO ALGORITMO:', left, y);
		y += 4;
		doc.setFont('helvetica', 'normal');
		doc.text('Os cálculos de triangulação financeira (BTOR vs BTF) e os vereditos de risco são gerados por motor forense', left, y);
		y += 4;
		doc.text('imutável, com base exclusiva nos dados extraídos das evidências carregadas.', left, y);
		y += 10;
		doc.setFont('helvetica', 'bold');
		doc.setFontSize(9);
		doc.text('METADADOS DA PERÍCIA', left, y);
		y += 6;
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(8);
		doc.text(`${t.pdfLabelName}: ${UNIFEDSystem.client.name}`, left, y);
		y += 4;
		doc.text(`${t.pdfLabelNIF}: ${UNIFEDSystem.client.nif}`, left, y);
		y += 4;
		doc.text(`${t.pdfLabelPlatform}: ${platform.name}`, left, y);
		y += 4;
		doc.text(`${t.pdfLabelAddress}: ${platform.fullAddress || platform.address}`, left, y);
		y += 4;
		doc.text(`${t.pdfLabelNIFPlatform}: ${platform.nif}`, left, y);
		y += 4;
		doc.text(`Ano Fiscal: ${UNIFEDSystem.selectedYear}`, left, y);
		y += 4;
		doc.text(`Período: ${UNIFEDSystem.selectedPeriodo}`, left, y);
		y += 4;
		doc.text(`${t.pdfLabelTimestamp}: ${Math.floor(Date.now() / 1000)}`, left, y);
		y += 4;
		addFooter(doc, pageNumber);
		doc.addPage();
		pageNumber = 2;
		y = 20; {
			...
			doc.text('Objeto:', left, y);
			y += 4;
			doc.setFont('helvetica', 'normal');
			doc.setTextColor(0, 0, 0);
			const _cedObj = doc.splitTextToSize('Análise de Discrepâncias de Terceiros (Plataformas Digitais) atuando sob monopólio de faturação (Art. 36.º, n.º 11 CIVA).', _cedW - 5);
			doc.text(_cedObj, left + 3, y);
			y += (_cedObj.length * 4.2) + 3;
			doc.setFont('helvetica', 'bold');
			doc.setTextColor(30, 30, 100);
			doc.text('Fundamentação:', left, y);
			y += 4;
			doc.setFont('helvetica', 'normal');
			doc.setTextColor(0, 0, 0);
			const _cedFund = doc.splitTextToSize('Art. 104.º n.º 2 RGIT (Fraude Qualificada) e Art. 125.º CPP.', _cedW - 5);
			doc.text(_cedFund, left + 3, y);
			y += (_cedFund.length * 4.2) + 3;
			doc.setFont('helvetica', 'bold');
			doc.setTextColor(30, 30, 100);
			doc.text('Evidência:', left, y);
			y += 4;
			doc.setFont('helvetica', 'normal');
			doc.setTextColor(0, 0, 0);
			const _cedEv = doc.splitTextToSize('Omissão de base tributável por divergência entre Ganhos Reais efetivos (Ledger/Extrato) e o Reporte Fiscal submetido pela plataforma (SAF-T/DAC7).', _cedW - 5);
			doc.text(_cedEv, left + 3, y);
			y += (_cedEv.length * 4.2) + 3;
			doc.setFont('helvetica', 'bold');
			doc.setTextColor(150, 20, 20);
			doc.text('Conclusão Pericial:', left, y);
			y += 4;
			doc.setFont('helvetica', 'normal');
			doc.setTextColor(0, 0, 0);
			const _cedConc = doc.splitTextToSize('A retenção sistemática de percentagens em comissões sem a devida faturação constitui apropriação indevida e indicia crime tributário de omissão de proveitos por parte da entidade processadora.', _cedW - 5);
			doc.text(_cedConc, left + 3, y);
			y += (_cedConc.length * 4.2) + 8;
		}
		doc.setFontSize(10);
		doc.setFont('helvetica', 'bold');
		...
		const rows = [{
			desc: currentLang === 'pt' ? 'Ganhos Brutos (Extrato Ledger)' : 'Gross Earnings (Ledger Statement)',
			value: totals.ganhos,
			source: currentLang === 'pt' ? 'Plataforma Digital' : 'Digital Platform',
			isBruto: true
		}, {
			desc: currentLang === 'pt' ? 'Ganhos Reportados (DAC7 · Plataforma Digital)' : 'Reported Earnings (DAC7 · Digital Platform)',
			value: totals.dac7TotalPeriodo,
			source: currentLang === 'pt' ? 'Plataforma (DAC7)' : 'Platform (DAC7)'
		}, {
			desc: currentLang === 'pt' ? 'Comissões Retidas (Extrato)' : 'Retained Commissions (Statement)',
			value: totals.despesas,
			source: currentLang === 'pt' ? 'Plataforma Digital' : 'Digital Platform',
			isGap: true
		}, {
			desc: currentLang === 'pt' ? 'Comissões Faturadas (PT1124+PT1125)' : 'Invoiced Commissions (PT1124+PT1125)',
			value: totals.faturaPlataforma,
			source: currentLang === 'pt' ? 'Faturas BTF' : 'BTF Invoices'
		}, {
			desc: '-------------------------------------------',
			value: null,
			source: ''
		}, {
			desc: currentLang === 'pt' ? '[!] SAF-T Valor Bruto Total vs DAC7 (Revenue Omission)' : '[!] SAF-T Gross Value vs DAC7 (Revenue Omission)',
			value: cross.discrepanciaSaftVsDac7,
			source: currentLang === 'pt' ? 'Smoking Gun 1' : 'Smoking Gun 1',
			isGap: true
		}, {
			desc: currentLang === 'pt' ? `[X] Diferencial de Base em Análise (Despesas/Comissões vs Fatura) [${_pctOmissaoStr}]` : `[X] Base Differential Under Analysis (Expenses/Commissions vs Invoice) [${_pctOmissaoStr}]`,
			value: cross.discrepanciaCritica,
			source: currentLang === 'pt' ? 'Smoking Gun 2' : 'Smoking Gun 2',
			isCritical: true
		}, {
			desc: currentLang === 'pt' ? 'IVA Omitido (23% · Autoliquidação CIVA)' : 'Missing VAT (23% · VAT Self-Liquidation)',
			value: cross.ivaFalta,
			source: currentLang === 'pt' ? 'Cálculo CIVA' : 'VAT Calculation',
			isGap: true
		}, {
			desc: currentLang === 'pt' ? 'IVA Omitido (6% · Serviços Transporte)' : 'Missing VAT (6% · Transport Services)',
			value: cross.ivaFalta6,
			source: currentLang === 'pt' ? 'Cálculo CIVA' : 'VAT Calculation',
			isGap: true
		}];
		rows.forEach(row => {
		...
		doc.setTextColor(0, 0, 0);
		doc.setFont('helvetica', 'bold');
		const vLine1 = doc.splitTextToSize(`${currentLang === 'pt' ? 'Expense Omission / Omissao Custos:' : 'Expense Omission:'} ${_pctOmissaoStr}  |  ${currentLang === 'pt' ? 'Gross Earnings:' : 'Gross Earnings:'} ${formatCurrency(totals.ganhos)}`, usableW);
		const vLine2 = doc.splitTextToSize(`${currentLang === 'pt' ? 'Revenue Gap (DAC7):' : 'Revenue Gap (DAC7):'} ${formatCurrency(cross.discrepanciaSaftVsDac7)} (${_pctReceitaStr})`, usableW);
		doc.text(vLine1, left, y);
		y += (vLine1.length * 4.5);
		doc.text(vLine2, left, y);
		y += (vLine2.length * 4.5) + 4;
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(8);
		const verdictDescLines = doc.splitTextToSize(verdict.description[currentLang], usableW);
		doc.text(verdictDescLines, left, y);
		y += (verdictDescLines.length * 4.5) + 8;
		doc.setFontSize(10);
		doc.setFont('helvetica', 'bold');
		...
		doc.setFontSize(9);
		doc.setFont('helvetica', 'bold');
		doc.text('SMOKING GUN 1 — SAF-T Valor Bruto Total vs DAC7 / Omissão de Receita:', left, y);
		y += 5;
		doc.setFont('helvetica', 'normal');
		doc.text(`  ${currentLang === 'pt' ? 'Ganhos Brutos (Auditado):' : 'Gross Earnings (Audited):'}          ${formatCurrency(totals.ganhos)}`, left, y);
		y += 4;
		doc.text(`  ${currentLang === 'pt' ? 'Ganhos Reportados (DAC7):' : 'Reported Earnings (DAC7):'}          ${formatCurrency(totals.dac7TotalPeriodo)}`, left, y);
		y += 4;
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(245, 158, 11);
		doc.text(`  [!]  ${currentLang === 'pt' ? 'DIFERENÇA OMITIDA (AT):' : 'OMITTED DIFFERENCE (TA):'}         ${formatCurrency(cross.discrepanciaSaftVsDac7)}`, left, y);
		y += 7;
		doc.setTextColor(0, 0, 0);
		doc.setFont('helvetica', 'bold');
		doc.text('SMOKING GUN 2 — Diferencial de Base em Análise (Despesas/Comissões vs Fatura BTF):', left, y);
		y += 5;
		doc.setFont('helvetica', 'normal');
		doc.text(`  ${currentLang === 'pt' ? 'Comissões Retidas (Extrato):' : 'Commissions Withheld (Statement):'}       ${formatCurrency(totals.despesas)}`, left, y);
		y += 4;
		doc.text(`  ${currentLang === 'pt' ? 'Comissões Faturadas (BTF):' : 'Invoiced Commissions (BTF):'}         ${formatCurrency(totals.faturaPlataforma)}`, left, y);
		y += 4;
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(239, 68, 68);
		doc.text(`  [X] ${currentLang === 'pt' ? 'OMISSÃO DE FATURAÇÃO:' : 'INVOICE OMISSION:'}            ${formatCurrency(cross.discrepanciaCritica)} (${_pctOmissaoStr})`, left, y);
		y += 7;
		doc.setTextColor(0, 0, 0);
		doc.setFont('helvetica', 'normal');
		doc.text(`${currentLang === 'pt' ? 'IVA Omitido (23%):' : 'Missing VAT (23%):'}  ${formatCurrency(cross.ivaFalta)}`, left, y);
		y += 4;
		doc.text(`${currentLang === 'pt' ? 'IVA Omitido (6%):' : 'Missing VAT (6%):'}   ${formatCurrency(cross.ivaFalta6)}`, left, y);
		y += 8;
		doc.setDrawColor(200, 200, 200);
		...
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(9);
		doc.text(`${currentLang === 'pt' ? 'Artigo 2.º, n.º 1, alínea i) do Código do IVA:' : 'Article 2, no. 1, subparagraph i) of the VAT Code:'}`, left, y);
		y += 5;
		doc.text(`${currentLang === 'pt' ? 'Regime de autoliquidação aplicável a serviços prestados por sujeitos' : 'Self-assessment regime applicable to services provided by non-resident'}`, left, y);
		y += 4;
		doc.text(`${currentLang === 'pt' ? 'passivos não residentes em território português.' : 'taxpayers in Portuguese territory.'}`, left, y);
		y += 6;
		doc.text(`• ${currentLang === 'pt' ? 'IVA Omitido: 23% sobre despesas reais vs faturadas' : 'Missing VAT: 23% on actual expenses vs invoiced'}`, left, y);
		y += 5;
		doc.text(`• ${currentLang === 'pt' ? 'IVA Omitido: 6% sobre serviços de transporte' : 'Missing VAT: 6% on transport services'}`, left, y);
		y += 5;
		doc.text(`• ${currentLang === 'pt' ? 'Base Tributável: Diferença detetada na matriz (BTOR vs BTF)' : 'Taxable Base: Difference detected in the matrix (BTOR vs BTF)'}`, left, y);
		y += 5;
		doc.text(`• ${currentLang === 'pt' ? 'Prazo Regularização: 30 dias após deteção' : 'Settlement Deadline: 30 days after detection'}`, left, y);
		y += 5;
		doc.text(`• ${currentLang === 'pt' ? 'Sanções Aplicáveis: Artigo 108.º do CIVA' : 'Applicable Sanctions: Article 108 of the VAT Code'}`, left, y);
		y += 10;
		doc.text(`${currentLang === 'pt' ? 'Artigo 108.º do CIVA - Infrações:' : 'Article 108 of the VAT Code - Offenses:'}`, left, y);
		y += 5;
		doc.text(`${currentLang === 'pt' ? 'Constitui infração a falta de liquidação do imposto devido,' : 'It is an offense to fail to settle the tax due,'}`, left, y);
		y += 4;
		doc.text(`${currentLang === 'pt' ? 'bem como a sua liquidação inferior ao montante legalmente exigível.' : 'as well as its settlement lower than the legally required amount.'}`, left, y);
		y += 10;
		doc.text(`${currentLang === 'pt' ? 'Decreto-Lei n.º 28/2019:' : 'Decree-Law no. 28/2019:'}`, left, y);
		y += 5;
		doc.text(`${currentLang === 'pt' ? 'Integridade do processamento de dados e validade de documentos' : 'Integrity of data processing and validity of electronic documents'}`, left, y);
		y += 4;
		doc.text(`${currentLang === 'pt' ? 'eletrónicos como registos primários.' : 'as primary records.'}`, left, y);
		y += 10;
		doc.setFont('helvetica', 'bold');
		doc.setFontSize(9);
		doc.setTextColor(30, 60, 120);
		doc.text(`${currentLang === 'pt' ? 'ADMISSIBILIDADE DA PROVA DIGITAL:' : 'ADMISSIBILITY OF DIGITAL EVIDENCE:'}`, left, y);
		y += 5;
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(8);
		doc.setTextColor(0, 0, 0);
		doc.text(`• ${currentLang === 'pt' ? 'Art. 125.º CPP — São admissíveis como meios de prova todos os meios não proibidos por lei.' : 'Art. 125 CPP — All means of proof not prohibited by law are admissible.'}`, left, y, {
			maxWidth: doc.internal.pageSize.getWidth() - 30
		});
		y += 5;
		doc.text(`  ${currentLang === 'pt' ? 'Esta prova digital material foi produzida com metodologia forense certificada e cadeia de custódia' : 'This material digital evidence was produced with certified forensic methodology and chain of custody'}`, left, y, {
			maxWidth: doc.internal.pageSize.getWidth() - 30
		});
		y += 4;
		doc.text(`  ${currentLang === 'pt' ? 'documentada, sendo plenamente admissível perante as Instâncias Judiciais Competentes.' : 'documented, being fully admissible before the Competent Judicial Authorities.'}`, left, y);
		y += 6;
		doc.text(`• ${currentLang === 'pt' ? 'Art. 32.º CRP — Garantias de Defesa: o processo penal assegura todas as garantias' : 'Art. 32 CRP — Defense Guarantees: criminal proceedings ensure all guarantees'}`, left, y, {
			maxWidth: doc.internal.pageSize.getWidth() - 30
		});
		y += 4;
		doc.text(`  ${currentLang === 'pt' ? 'de defesa, incluindo o recurso à prova técnica pericial para contraditório fundamentado.' : 'of defense, including the use of expert technical evidence for substantiated contradiction.'}`, left, y);
		y += 6;
		doc.text(`• ${currentLang === 'pt' ? 'Art. 103.º RGIT — Fraude Fiscal: omissão de proveitos e retenção indevida de IVA.' : 'Art. 103 RGIT — Tax Fraud: omission of income and improper VAT withholding.'}`, left, y, {
			maxWidth: doc.internal.pageSize.getWidth() - 30
		});
		y += 5;
		doc.text(`• ${currentLang === 'pt' ? 'Art. 104.º RGIT — Fraude Fiscal Qualificada: quando a omissão excede os limiares legais.' : 'Art. 104 RGIT — Qualified Tax Fraud: when the omission exceeds legal thresholds.'}`, left, y, {
			maxWidth: doc.internal.pageSize.getWidth() - 30
		});
		y += 8;
		doc.setFontSize(10);
		...
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(9);
		doc.text(`BTOR (Bank Transactions Over Reality):`, left, y);
		y += 5;
		doc.text(`${currentLang === 'pt' ? 'Análise comparativa entre despesas reais (extratos) e' : 'Comparative analysis between real expenses (statements) and'}`, left, y);
		y += 4;
		doc.text(`${currentLang === 'pt' ? 'documentação fiscal declarada (faturas).' : 'declared tax documentation (invoices).'}`, left, y);
		y += 6;
		doc.text(`• ${currentLang === 'pt' ? 'Mapeamento posicional de dados SAF-T/Relatório (colunas 14,15,16)' : 'Positional mapping of SAF-T/Report data (columns 14,15,16)'}`, left, y);
		y += 5;
		doc.text(`• ${currentLang === 'pt' ? 'Extração precisa da tabela "Ganhos líquidos" do extrato' : 'Accurate extraction of the "Net Earnings" table from the statement'}`, left, y);
		y += 5;
		doc.text(`• ${currentLang === 'pt' ? 'Cálculo de duas discrepâncias: despesas e SAF-T/Relatório vs DAC7' : 'Calculation of two discrepancies: expenses and SAF-T/Report vs DAC7'}`, left, y);
		y += 5;
		doc.text('> Geracao de prova tecnica auditavel com hashes SHA-256', left, y);
		y += 10;
		if(y > 220) {
			doc.addPage();
			pageNumber++;
			...
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			const _isrs1 = doc.splitTextToSize(currentLang === 'pt' ? 'O presente estudo foi elaborado em estrita conformidade com a Norma Internacional de Serviços Relacionados ISRS 4400 ' + '(Procedimentos Acordados sobre Informação Financeira), garantindo que os procedimentos aplicados são objetivos, ' + 'reprodutíveis e auditáveis por qualquer perito independente. O analista declara total independência face às partes ' + 'e ausência de conflito de interesses, nos termos do Art. 467.º do CPC e Art. 153.º do CPP.' : 'This study was prepared in strict compliance with the International Standard on Related Services ISRS 4400 ' + '(Agreed-Upon Procedures on Financial Information), ensuring that the procedures applied are objective, ' + 'reproducible and auditable by any independent expert. The analyst declares total independence from the parties ' + 'and absence of conflict of interest, under the terms of Art. 467 CPC and Art. 153 CPP.', _isrsW);
			doc.text(_isrs1, left, y);
			y += (_isrs1.length * 3.8) + 3;
			const _isrs2 = doc.splitTextToSize(currentLang === 'pt' ? 'ESCOPO: O estudo limita-se à análise objetiva dos documentos fornecidos (extratos de plataforma, SAF-T, DAC7, ' + 'faturas). As conclusões constituem estudo de viabilidade pericial e não substituem relatório pericial homologado ' + 'por Tribunal. A sua produção assenta em metodologia BTOR (Bank Transactions Over Reality), com rastreabilidade ' + 'criptográfica completa (SHA-256 + RFC 3161).' : 'SCOPE: The study is limited to the objective analysis of the documents provided (platform statements, SAF-T, DAC7, ' + 'invoices). The conclusions constitute a feasibility study and do not replace an expert report approved by the Court. ' + 'Its production is based on BTOR methodology (Bank Transactions Over Reality), with complete cryptographic ' + 'traceability (SHA-256 + RFC 3161).', _isrsW);
			doc.text(_isrs2, left, y);
			y += (_isrs2.length * 3.8) + 6;
		}
		if(y > 220) {
			doc.addPage();
			pageNumber++;
			...
			const _riskRows = [{
				...
				fund: 'Art. 103.º RGIT',
				desc: currentLang === 'pt' ? 'Omissão de proveitos e retenção indevida de IVA sobre comissões. Pena: prisão até 3 anos ou multa.' : 'Omission of income and improper VAT withholding on commissions. Penalty: imprisonment up to 3 years or fine.'
			}, {
				tipo: currentLang === 'pt' ? 'FRAUDE FISCAL QUALIFICADA' : 'QUALIFIED TAX FRAUD',
				fund: 'Art. 104.º RGIT',
				desc: currentLang === 'pt' ? 'Quando a vantagem patrimonial obtida excede 15 vezes o salário mínimo nacional anual.' : 'When the asset advantage obtained exceeds 15 times the national annual minimum wage.'
			}, {
				tipo: currentLang === 'pt' ? 'BRANQUEAMENTO DE CAPITAIS' : 'MONEY LAUNDERING',
				fund: 'Lei 83/2017 (BCFT)',
				desc: currentLang === 'pt' ? 'Dissimulação da origem de fundos provenientes de omissão fiscal através de fluxos algorítmicos opacos.' : 'Concealment of the origin of funds from tax omission through opaque algorithmic flows.'
			}, {
				tipo: currentLang === 'pt' ? 'GESTÃO DANOSA' : 'HARMFUL MANAGEMENT',
				fund: 'Art. 235.º CP',
				desc: currentLang === 'pt' ? 'Gestão dolosa que causa prejuízo à Autoridade Tributária e ao parceiro operador.' : 'Intentional management that causes harm to the Tax Authority and the operating partner.'
			}, {
				tipo: currentLang === 'pt' ? 'VIOLAÇÃO DAC7' : 'DAC7 VIOLATION',
				fund: 'Diretiva (UE) 2021/514',
				desc: currentLang === 'pt' ? 'Incumprimento das obrigacoes de reporte automatico de rendimentos as Autoridades Fiscais dos Estados-Membros (EM).' : 'Failure to comply with the automatic reporting obligations to the Tax Authorities of the Member States (MS).'
			}, ];
			_riskRows.forEach(row => {
				doc.setFont('helvetica', 'bold');
				doc.setFontSize(7.5);
				doc.setTextColor(150, 20, 20);
				doc.text(`> ${row.tipo} [${row.fund}]`, left + 2, y);
				y += 4;
				doc.setFont('helvetica', 'normal');
				doc.setTextColor(0, 0, 0);
				const _descLines = doc.splitTextToSize(row.desc, _riskW - 6);
				doc.text(_descLines, left + 6, y);
				y += (_descLines.length * 3.5) + 3;
			});
			y += 3;
		}
		if(y > 220) {
			...
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			const _jur1 = doc.splitTextToSize(currentLang === 'pt' ? 'A eventual invocação de sede social em jurisdição estrangeira (nomeadamente na República da Estónia, ' + 'onde diversas plataformas de economia de plataforma estão registadas) não constitui fundamento válido ' + 'de exclusão da responsabilidade fiscal e penal em território português.' : 'The possible invocation of a registered office in a foreign jurisdiction (namely in the Republic of Estonia, ' + 'where several platform economy platforms are registered) does not constitute a valid basis for excluding ' + 'tax and criminal liability in Portuguese territory.', _jurW);
			doc.text(_jur1, left, y);
			y += (_jur1.length * 3.8) + 3;
			const _jur2 = doc.splitTextToSize(currentLang === 'pt' ? 'Fundamento legal: (1) Art. 18.º da Lei Geral Tributária (LGT) — a obrigação tributária nasce no local ' + 'onde o facto tributário ocorre (Lex Loci Solutionis), independentemente da sede do operador; ' + '(2) Diretiva (UE) 2021/514 (DAC7), Art. 4.º — os operadores de plataformas digitais com utilizadores ' + 'em Estados-Membros estão sujeitos a obrigações de reporte à Autoridade Tributária do Estado-Membro de ' + 'atividade, independentemente da sua sede; (3) Regulamento (CE) n.º 593/2008 (Roma I) — a lei aplicável ' + 'aos contratos de prestação de serviços é a lei do país onde o prestador tem a sua residência habitual ' + 'ou, no caso de consumidores, a lei do país de residência deste.' : 'Legal basis: (1) Art. 18 of the General Tax Law (LGT) — the tax obligation arises at the location where ' + 'the taxable event occurs (Lex Loci Solutionis), regardless of the operator\'s headquarters; ' + '(2) Directive (EU) 2021/514 (DAC7), Art. 4 — digital platform operators with users in Member States ' + 'are subject to reporting obligations to the Tax Authority of the Member State of activity, regardless of their headquarters; ' + '(3) Regulation (EC) No. 593/2008 (Rome I) — the applicable law to service contracts is the law of the country where the provider has their habitual residence ' + 'or, in the case of consumers, the law of the country of residence of the consumer.', _jurW);
			doc.text(_jur2, left, y);
			y += (_jur2.length * 3.8) + 6;
		}
		doc.setFontSize(10);
		doc.setFont('helvetica', 'bold');
		...
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(9);
		doc.text(`${currentLang === 'pt' ? 'Sistema de peritagem forense estruturado em conformidade com as normas, com selo de' : 'Forensic expertise system structured in accordance with standards, with seal of'}`, left, y);
		y += 4;
		doc.text(`${currentLang === 'pt' ? 'integridade digital SHA-256. Todos os relatorios sao' : 'digital integrity SHA-256. All reports are'}`, left, y);
		y += 4;
		doc.text(`${currentLang === 'pt' ? 'temporalmente selados e auditáveis.' : 'temporally sealed and auditable.'}`, left, y);
		y += 8;
		doc.text('Algoritmo Hash: SHA-256 (Forense)', left, y);
		y += 5;
		doc.text(`Timestamp: RFC 3161`, left, y);
		y += 5;
		doc.text(`${currentLang === 'pt' ? 'Validade Prova: Indeterminada' : 'Proof Validity: Indeterminate'}`, left, y);
		y += 5;
		doc.text(`Certificação: UNIFED - PROBATUM v13.5.0-PURE · DORA COMPLIANT`, left, y);
		y += 5;
		doc.setFont('helvetica', 'italic');
		doc.setFontSize(7);
		doc.text(`${currentLang === 'pt' ? 'Este relatório cumpre com o Regulamento (UE) 2022/2554 (DORA) - Digital Operational Resilience Act, assegurando a resiliência operacional digital e a integridade das evidências digitais processadas.' : 'This report complies with Regulation (EU) 2022/2554 (DORA) - Digital Operational Resilience Act, ensuring digital operational resilience and integrity of processed digital evidence.'}`, left, y, {
			maxWidth: doc.internal.pageSize.getWidth() - 30
		});
		y += 8;
		doc.setFont('helvetica', 'normal');
		...
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(9);
		doc.text(`I. ${currentLang === 'pt' ? 'ANÁLISE PERICIAL' : 'EXPERT ANALYSIS'} (${periodoTexto}):`, left, y);
		y += 5;
		doc.text(currentLang === 'pt' ? 'Duas discrepâncias fundamentais detetadas (Verdade Material Auditada):' : 'Two fundamental critical divergences detected (Audited Material Truth):', left, y, {
			maxWidth: doc.internal.pageSize.getWidth() - 30
		});
		y += 5;
		...
		doc.text('C1. SAF-T VALOR BRUTO TOTAL vs DAC7 (Sub-comunicação Plataforma→Estado):', left, y);
		y += 5;
		doc.setFont('helvetica', 'normal');
		doc.setTextColor(0, 0, 0);
		doc.text(`     ${currentLang === 'pt' ? 'SAF-T Valor Bruto Total (Faturação Interna):' : 'SAF-T Total Gross Value (Internal Invoicing):'}  ${formatCurrency(totals.saftBruto)}`, left, y);
		y += 4;
		doc.text(`     ${currentLang === 'pt' ? 'DAC7 Reportado à AT (Plataforma Digital):' : 'DAC7 Reported to TA (Digital Platform):'}     ${formatCurrency(totals.dac7TotalPeriodo)}`, left, y);
		y += 4;
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(245, 158, 11);
		doc.text(`     → Δ C1: ${formatCurrency(cross.c1_delta || (totals.saftBruto - totals.dac7TotalPeriodo))} (${(cross.c1_pct || 0).toFixed(2)}%) — ${currentLang === 'pt' ? 'Omissão de receita ao Estado' : 'Revenue omission to the State'}`, left, y);
		y += 6;
		doc.setTextColor(0, 0, 0);
		doc.setFont('helvetica', 'normal');
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(0, 80, 160);
		doc.text('C2. DESPESAS/COMISSÕES EXTRATO vs FATURADO (Prova Rainha — Retenção Ilegal):', left, y);
		y += 5;
		doc.setFont('helvetica', 'normal');
		doc.setTextColor(0, 0, 0);
		doc.text(`     ${currentLang === 'pt' ? 'Comissões Retidas — Extrato Bancário (BTOR):' : 'Commissions Withheld — Bank Statement (BTOR):'}  ${formatCurrency(totals.despesas)}`, left, y);
		y += 4;
		doc.text(`     ${currentLang === 'pt' ? 'Comissões Faturadas — Plataforma (BTF):' : 'Invoiced Commissions — Platform (BTF):'}       ${formatCurrency(totals.faturaPlataforma)}`, left, y);
		y += 4;
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(239, 68, 68);
		doc.text(`     → Δ C2 [SG-2]: ${formatCurrency(cross.discrepanciaCritica)} (${_pctOmissaoStr}) — ${currentLang === 'pt' ? 'Diferencial de Base em Análise' : 'Base Differential Under Analysis'}`, left, y);
		y += 6;
		doc.setTextColor(0, 0, 0);
		doc.setFont('helvetica', 'normal');
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(0, 80, 160);
		doc.text('C3. SAF-T VALOR BRUTO TOTAL vs GANHOS (EXTRATO) (Viagens Faturadas vs Transferências):', left, y);
		y += 5;
		doc.setFont('helvetica', 'normal');
		doc.setTextColor(0, 0, 0);
		doc.text(`     ${currentLang === 'pt' ? 'SAF-T Valor Bruto (Viagens Faturadas — Sistema):' : 'SAF-T Gross Value (Invoiced Trips — System):'}  ${formatCurrency(totals.saftBruto)}`, left, y);
		y += 4;
		doc.text(`     ${currentLang === 'pt' ? 'Ganhos Extrato (Transferências Efetivas — Banco):' : 'Statement Earnings (Actual Transfers — Bank):'} ${formatCurrency(totals.ganhos)}`, left, y);
		y += 4;
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(245, 158, 11);
		doc.text(`     → Δ C3: ${formatCurrency(cross.c3_delta || (totals.saftBruto - totals.ganhos))} (${(cross.c3_pct || 0).toFixed(2)}%) — ${currentLang === 'pt' ? 'Gap entre faturado e transferido' : 'Gap between invoiced and transferred'}`, left, y);
		y += 6;
		doc.setTextColor(0, 0, 0);
		doc.setFont('helvetica', 'normal');
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(0, 80, 160);
		doc.text('C4. GANHOS LÍQUIDOS DECLARADOS vs LÍQUIDO REAL EXTRATO (Impacto Final SP):', left, y);
		y += 5;
		doc.setFont('helvetica', 'normal');
		doc.setTextColor(0, 0, 0);
		doc.text(`     ${currentLang === 'pt' ? 'Líquido Declarado/Fiscal (SAF-T − Fatura):' : 'Declared/Tax Net (SAF-T − Invoice):'}     ${formatCurrency(cross.c4_liquidoDeclarado || (totals.saftBruto - totals.faturaPlataforma))}`, left, y);
		y += 4;
		doc.text(`     ${currentLang === 'pt' ? 'Líquido Real — Extrato (Ganhos Líquidos SP):' : 'Actual Net — Statement (Net Earnings SP):'}   ${formatCurrency(totals.ganhosLiquidos)}`, left, y);
		y += 4;
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(239, 68, 68);
		doc.text(`     → Δ C4: ${formatCurrency(cross.c4_delta || 0)} (${(cross.c4_pct || 0).toFixed(2)}%) — ${currentLang === 'pt' ? 'Diferença final no bolso do sujeito passivo' : 'Final difference in the taxpayer\'s pocket'}`, left, y);
		y += 6;
		doc.setTextColor(0, 0, 0);
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(10);
		...
		doc.text(`${currentLang === 'pt' ? 'Valor' : 'Amount'}`, FIS_COL_VAL, y, {
			align: 'right'
		});
		doc.text('%', FIS_COL_PCT, y, {
			align: 'right'
		});
		doc.setTextColor(0, 0, 0);
		y += 6;
		...
		const fisRows = [{
			desc: currentLang === 'pt' ? 'VAT 23% / IVA Omitido (23% Autoliquidação CIVA)' : 'VAT 23% / Missing VAT (23% VAT Self-Liquidation)',
			val: cross.ivaFalta,
			pct: null,
			highlight: false
		}, {
			desc: currentLang === 'pt' ? 'VAT 6% / IVA Omitido (6% Transporte)' : 'VAT 6% / Missing VAT (6% Transport)',
			val: cross.ivaFalta6,
			pct: null,
			highlight: false
		}, {
			desc: currentLang === 'pt' ? 'Revenue Omission (DAC7) / Omissão de Receita' : 'Revenue Omission (DAC7)',
			val: cross.discrepanciaSaftVsDac7,
			pct: _pctReceitaStr,
			highlight: false
		}, {
			desc: currentLang === 'pt' ? 'Expense Omission / Omissão de Custos (C2)' : 'Expense Omission (C2)',
			val: cross.discrepanciaCritica,
			pct: _pctOmissaoStr,
			highlight: true
		}, {
			desc: currentLang === 'pt' ? 'Annual Omitted Base / Projeção Anual (C2 × 12 meses)' : 'Annual Omitted Base (C2 × 12 months)',
			val: cross.discrepanciaCritica * 12,
			pct: null,
			highlight: false
		}, {
			desc: currentLang === 'pt' ? 'Estimated IRC Impact / Impacto IRC Anual' : 'Estimated IRC Impact',
			val: cross.discrepanciaCritica * 12 * 0.21,
			pct: null,
			highlight: false
		}, {
			desc: currentLang === 'pt' ? 'Contribuição IMT/AMT Omitida (5%)' : 'Missing IMT/AMT Contribution (5%)',
			val: cross.discrepancia5IMT,
			pct: null,
			highlight: false
		}, {
			desc: currentLang === 'pt' ? 'Agravamento Bruto IRC (C2 ÷ Meses × 12)' : 'Gross IRC Aggravation (C2 ÷ Months × 12)',
			val: cross.agravamentoBrutoIRC,
			pct: null,
			highlight: false
		}, {
			desc: currentLang === 'pt' ? 'IRC Estimado (21% sobre Agravamento Anual)' : 'Estimated IRC (21% on Annual Aggravation)',
			val: cross.ircEstimado,
			pct: null,
			highlight: false
		}, {
			desc: currentLang === 'pt' ? 'Impacto Mensal · 38.000 condutores PT' : 'Monthly Impact · 38,000 drivers PT',
			val: cross.impactoMensalMercado,
			pct: null,
			highlight: false
		}, {
			desc: currentLang === 'pt' ? 'Impacto Anual · 38.000 condutores × 12 meses PT' : 'Annual Impact · 38,000 drivers × 12 months PT',
			val: cross.impactoAnualMercado,
			pct: null,
			highlight: false
		}, {
			desc: currentLang === 'pt' ? '% Omissão Receita SAF-T vs DAC7' : '% Revenue Omission SAF-T vs DAC7',
			val: null,
			pct: (cross.percentagemSaftVsDac7 || 0).toFixed(2) + '%',
			highlight: false
		}, {
			desc: currentLang === 'pt' ? '% Diferencial de Base em Análise (Desp. vs Fat.)' : '% Base Differential Under Analysis (Exp. vs Inv.)',
			val: null,
			pct: (cross.percentagemOmissao || 0).toFixed(2) + '%',
			highlight: false
		}];
		fisRows.forEach((row, i) => {
			...
			if(row.val !== null) {
				doc.text(formatCurrency(row.val), FIS_COL_VAL, y, {
					align: 'right'
				});
			}
			if(row.pct) {
				doc.text(row.pct, FIS_COL_PCT, y, {
					align: 'right'
				});
			}
		...
		doc.setFontSize(8);
		doc.setTextColor(239, 68, 68);
		const macroLine4 = doc.splitTextToSize(`${currentLang === 'pt' ? 'IMPACTO SISTÉMICO ESTIMADO (7 Anos · 38.000 operadores × 12 meses):' : 'ESTIMATED SYSTEMIC IMPACT (7 Years · 38,000 operators × 12 months):'} ${formatCurrency(_impactoMercado7Anos)}`, doc.internal.pageSize.getWidth() - 30);
		doc.text(macroLine4, left, y);
		y += (macroLine4.length * 4.5) + 2;
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(7.5);
		doc.setTextColor(80, 80, 80);
		const macroNota2 = doc.splitTextToSize(currentLang === 'pt' ? 'Esta perícia revela um padrão de omissão que, extrapolado ao universo de 38.000 operadores, ' + 'representa uma exposição tributária de ' + formatCurrency(_impactoMercado7Anos) + '. ' + 'Este dado fundamenta a relevância da presente ação para a tutela de interesses coletivos ' + 'e correção de distorções de mercado. Projeção: Omissão mensal média × 38.000 motoristas TVDE ' + '(INE/IMT) × 12 meses × 7 anos (prazo Art. 45.º LGT). ' + 'Projeção fundamenta relevância processual para escritórios de elite (Projection supports legal relevance for elite law firms).' : 'This expertise reveals a pattern of omission which, extrapolated to the universe of 38,000 operators, ' + 'represents a tax exposure of ' + formatCurrency(_impactoMercado7Anos) + '. ' + 'This data underpins the relevance of this action for the protection of collective interests ' + 'and correction of market distortions. Projection: Average monthly omission × 38,000 TVDE drivers ' + '(INE/IMT) × 12 months × 7 years (deadline Art. 45 LGT). ' + 'Projection supports legal relevance for elite law firms (Projeção fundamenta relevância processual para escritórios de elite).', doc.internal.pageSize.getWidth() - 35);
		doc.text(macroNota2, left + 5, y);
		y += (macroNota2.length * 3.5) + 2;
		doc.setFont('helvetica', 'italic');
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(9);
		doc.setTextColor(0, 0, 0);
		if(y > 235) {
			...
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			const _perdaText = doc.splitTextToSize(currentLang === 'pt' ? 'Dano Reputacional e Perda de Chance: O reporte viciado da plataforma à Autoridade Tributária ' + '(com uma discrepância detetada de ' + formatCurrency(cross.discrepanciaSaftVsDac7) + ') contamina diretamente o perfil de risco ' + '(Risk Scoring) do parceiro. Sendo a plataforma a detentora do monopólio de emissão documental ' + '(Art. 36.º n.º 11 CIVA), o sujeito passivo é penalizado sem dolo. ' + 'Esta adulteração do perfil fiscal gera lucros cessantes mensuráveis, inibindo o acesso a financiamento bancário, ' + 'linhas de crédito e benefícios fiscais, constituindo fundamento para indemnização por responsabilidade civil extracontratual.' : 'Reputational Damage and Loss of Chance: The platform\'s tainted reporting to the Tax Authority ' + '(with a detected discrepancy of ' + formatCurrency(cross.discrepanciaSaftVsDac7) + ') directly contaminates the risk profile ' + '(Risk Scoring) of the partner. Since the platform holds the monopoly on document issuance ' + '(Art. 36(11) CIVA), the taxpayer is penalized without intent. ' + 'This alteration of the tax profile generates measurable lost profits, inhibiting access to bank financing, ' + 'credit lines and tax benefits, constituting grounds for compensation for extra-contractual civil liability.', _perdaW - 3);
			doc.text(_perdaText, left + 3, y);
			y += (_perdaText.length * 4) + 6;
		}
		addFooter(doc, pageNumber);
		doc.addPage();
		pageNumber = 5;
		...
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(0, 229, 255);
		const adendaTitle = doc.splitTextToSize(currentLang === 'pt' ? 'FORENSIC ADDENDUM / ADENDA FORENSE — Strategic Intelligence & Bad Faith Analysis' : 'FORENSIC ADDENDUM / ADENDA FORENSE — Strategic Intelligence & Bad Faith Analysis', adendaPageW - 30);
		doc.text(adendaTitle, adendaPageW / 2, 17, {
			align: 'center'
		});
		doc.setTextColor(0, 0, 0);
		y = 30;
		...
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(239, 68, 68);
		doc.text(`${currentLang === 'pt' ? 'FORENSIC NOTE / NOTA TÉCNICA PERICIAL — Data Obfuscation Practices:' : 'FORENSIC NOTE / NOTA TÉCNICA PERICIAL — Data Obfuscation Practices:'}`, left, y);
		y += 6;
		doc.setTextColor(0, 0, 0);
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(8);
		const notaPrincLines = doc.splitTextToSize(currentLang === 'pt' ? 'A analise detetou praticas de obscurecimento de dados por parte da plataforma sob exame, nomeadamente a alteracao anual da estrutura de reporte (Ledger) e da sintaxe utilizada (moeda e separadores decimais), bem como a utilizacao do termo "Ganhos Liquidos" para designar meras transferencias bancarias, ocultando a natureza das retencoes efetuadas sem o devido suporte fiscal.' : 'The analysis detected data obfuscation practices by the platform under examination, namely the annual change in the reporting structure (Ledger) and the syntax used (currency and decimal separators), as well as the use of the term "Net Earnings" to designate mere bank transfers, hiding the nature of the withholdings made without proper tax support.', adendaUsableW);
		doc.text(notaPrincLines, left, y);
		y += (notaPrincLines.length * 4.5) + 6;
		doc.setFont('helvetica', 'bold');
		doc.setFontSize(9);
		const h1Lines = doc.splitTextToSize(currentLang === 'pt' ? '1. SYNTAX INCONSISTENCY / Inconsistencia de Sintaxe (Data Obfuscation - Level 1):' : '1. SYNTAX INCONSISTENCY / Inconsistencia de Sintaxe (Data Obfuscation - Level 1):', adendaUsableW);
		doc.text(h1Lines, left, y);
		y += (h1Lines.length * 4.5) + 2;
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(8);
		const p1Lines = doc.splitTextToSize(currentLang === 'pt' ? 'Dada a volatilidade das plataformas digitais, o sistema detetou que a estrutura de reporte (Ledger) e objeto de atualizacao anual. Exemplo material verificado na transicao 2024/2025: o campo anteriormente designado "Portagens" transitou para "Reembolsos de despesas". Adicionalmente, detetou-se a alteracao deliberada de separadores decimais (ponto vs. virgula) e do posicionamento do simbolo monetario (EUR) entre periodos anuais — exemplo: "7755.16EUR" torna-se "EUR 7.731,22" no ano seguinte. O UNIFED PROBATUM garante a reconciliacao de ambos os campos para efeitos de reconstrucao de passivo fiscal. Esta mutacao sintatica e semantica sistematica dificulta a leitura algoritmica automatica e impede a reconciliacao direta por auditores externos, constituindo indicio de manipulacao intencional do formato dos dados com o proposito de dificultar a auditoria forense.' : 'Given the volatility of digital platforms, the system detected that the reporting structure (Ledger) is subject to annual updates. Material example verified in the 2024/2025 transition: the field previously designated "Portagens" (Tolls) changed to "Reembolsos de despesas" (Expense Reimbursements). Additionally, the deliberate change of decimal separators (period vs. comma) and the positioning of the currency symbol (EUR) between annual periods was detected — example: "7755.16EUR" becomes "EUR 7.731,22" the following year. UNIFED PROBATUM guarantees the reconciliation of both fields for the purposes of reconstructing tax liability. This systematic syntactic and semantic mutation hinders automatic algorithmic reading and prevents direct reconciliation by external auditors, constituting evidence of intentional manipulation of data format with the purpose of hindering forensic auditing.', adendaIndentW - 3);
		doc.text(p1Lines, left + 3, y);
		y += (p1Lines.length * 4.5) + 5;
		doc.setFont('helvetica', 'bold');
		doc.setFontSize(9);
		const h2Lines = doc.splitTextToSize(currentLang === 'pt' ? '2. SEMANTIC AMBIGUITY / Ambiguidade Semantica ("Net Earnings" Masking - Fiscal Camouflage):' : '2. SEMANTIC AMBIGUITY / Ambiguidade Semantica ("Net Earnings" Masking - Fiscal Camouflage):', adendaUsableW);
		doc.text(h2Lines, left, y);
		y += (h2Lines.length * 4.5) + 2;
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(8);
		const p2Lines = doc.splitTextToSize(currentLang === 'pt' ? 'A plataforma utiliza o termo "Ganhos Liquidos" para designar meras transferencias bancarias brutas, camuflando retencoes de comissoes que nao deduzem os impostos devidos ao abrigo da Autoliquidacao de IVA (Art. 2.o, n.o 1, al. i) CIVA). Esta nomenclatura enganosa induz o sujeito passivo a declarar valores inferiores a base tributavel real, transferindo indevidamente o risco fiscal para o contribuinte.' : 'The platform uses the term "Net Earnings" to designate mere gross bank transfers, camouflaging commission withholdings that do not deduct taxes due under the VAT Self-Assessment (Art. 2(1)(i) CIVA). This misleading nomenclature induces the taxpayer to declare values lower than the real taxable base, improperly transferring the tax risk to the taxpayer.', adendaIndentW);
		doc.text(p2Lines, left + 3, y);
		y += (p2Lines.length * 4.5) + 5;
		doc.setFont('helvetica', 'bold');
		doc.setFontSize(9);
		const h3Lines = doc.splitTextToSize(currentLang === 'pt' ? '3. DATA OBFUSCATION - Limited Access Window / Janela de Acesso Limitada (Audit Trail Destruction):' : '3. DATA OBFUSCATION - Limited Access Window / Janela de Acesso Limitada (Audit Trail Destruction):', adendaUsableW);
		doc.text(h3Lines, left, y);
		y += (h3Lines.length * 4.5) + 2;
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(8);
		const p3Lines = doc.splitTextToSize(currentLang === 'pt' ? 'A plataforma impoe uma janela maxima de 6 meses para acesso a dados historicos detalhados (extratos de atividade). Esta limitacao temporal constitui uma estrategia de eliminacao de rasto de auditoria (audit trail destruction), impedindo a reconstrucao de series historicas superiores ao semestre. Nos termos do Art. 40.o do CIVA, os registos primarios devem ser conservados por 10 anos.' : 'The platform imposes a maximum window of 6 months for access to detailed historical data (activity statements). This temporal limitation constitutes a strategy of audit trail destruction, preventing the reconstruction of historical series longer than one semester. Under Art. 40 of the VAT Code, primary records must be kept for 10 years.', adendaIndentW);
		doc.text(p3Lines, left + 3, y);
		y += (p3Lines.length * 4.5) + 6;
		doc.setFont('helvetica', 'bold');
		doc.setFontSize(9);
		const h4Lines = doc.splitTextToSize(currentLang === 'pt' ? '4. TEMPORAL MISMATCH / Desalinhamento Temporal (Pagamentos Semanais vs Reporte Mensal):' : '4. TEMPORAL MISMATCH / Desalinhamento Temporal (Weekly Payments vs Monthly Reporting):', adendaUsableW);
		doc.text(h4Lines, left, y);
		y += (h4Lines.length * 4.5) + 2;
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(8);
		const p4Lines = doc.splitTextToSize(currentLang === 'pt' ? 'As plataformas procedem ao pagamento dos prestadores por transferencia bancaria semanal, contudo, a emissao dos documentos de reporte fiscal (extratos e faturas) ocorre em formato mensal agregado. Esta assimetria temporal constitui uma tatica de ofuscacao que inviabiliza a reconciliacao bancaria direta (cruzamento 1:1 entre extrato bancario e documento de reporte), dificultando deliberadamente auditorias financeiras e a deteção atempada das discrepâncias.' : 'Platforms make payments to providers by weekly bank transfer, however, the issuance of tax reporting documents (statements and invoices) occurs in aggregate monthly format. This temporal asymmetry constitutes an obfuscation tactic that makes direct bank reconciliation unfeasible (1:1 matching between bank statement and reporting document), deliberately hindering financial audits and the timely detection of discrepancies.', adendaIndentW);
		doc.text(p4Lines, left + 3, y);
		y += (p4Lines.length * 4.5) + 6;
		doc.setFont('helvetica', 'bold');
		doc.setFontSize(9);
		doc.setTextColor(239, 68, 68);
		doc.text(`${currentLang === 'pt' ? 'TAX FRAMEWORK / QUADRO TRIBUTÁRIO — Direct Financial Impact:' : 'TAX FRAMEWORK / QUADRO TRIBUTÁRIO — Direct Financial Impact:'}`, left, y);
		y += 5;
		doc.setTextColor(0, 0, 0);
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(8);
		doc.text(`  ${currentLang === 'pt' ? 'VAT 23% / IVA 23% Omitido (Autoliquidação):' : 'VAT 23% / Missing VAT 23% (Self-Assessment):'}      ${formatCurrency(cross.ivaFalta)}`, left, y);
		y += 4;
		doc.text(`  ${currentLang === 'pt' ? 'VAT 6% / IVA 6% Omitido (Transporte):' : 'VAT 6% / Missing VAT 6% (Transport):'}            ${formatCurrency(cross.ivaFalta6)}`, left, y);
		y += 4;
		doc.text(`  ${currentLang === 'pt' ? 'Revenue Omission (DAC7) / Omissão Receita:' : 'Revenue Omission (DAC7) / Omissão Receita:'}        ${formatCurrency(cross.discrepanciaSaftVsDac7)} (${_pctReceitaStr})`, left, y);
		y += 4;
		doc.text(`  ${currentLang === 'pt' ? 'Expense Omission / Omissão Custos (BTF):' : 'Expense Omission / Omissão Custos (BTF):'}          ${formatCurrency(cross.discrepanciaCritica)} (${_pctOmissaoStr})`, left, y);
		y += 6;
		doc.text(`  ${currentLang === 'pt' ? 'Contribuição IMT/AMT Omitida (5%):' : 'Missing IMT/AMT Contribution (5%):'}              ${formatCurrency(cross.discrepancia5IMT)}`, left, y);
		y += 4;
		doc.setFont('helvetica', 'bold');
		doc.setFontSize(10);
		doc.setTextColor(239, 68, 68);
		const macroLine = doc.splitTextToSize(`  ${currentLang === 'pt' ? 'IMPACTO SISTÉMICO ESTIMADO (7 Anos · 38.000 operadores PT):' : 'ESTIMATED SYSTEMIC IMPACT (7 Years · 38,000 operators PT):'} ${formatCurrency(_impactoMercado7Anos)}`, doc.internal.pageSize.getWidth() - 30);
		doc.text(macroLine, left, y);
		y += (macroLine.length * 4) + 2;
		doc.setFont('helvetica', 'italic');
		doc.setFontSize(7);
		doc.setTextColor(100, 100, 100);
		doc.text(currentLang === 'pt' ? '  * Projeção baseada na quota de mercado da GIG Economy PT (2019-2025). Suporta relevância legal. / Projeção mercado GIG Economy PT (2019-2025).' : '  * Projection based on PT GIG Economy market share (2019-2025). Supports legal relevance.', left, y, {
			maxWidth: doc.internal.pageSize.getWidth() - 30
		});
		y += 6;
		doc.setTextColor(0, 0, 0);
		...
		if(y > 225) {
			...
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			const _ccbLines = doc.splitTextToSize(currentLang === 'pt' ? 'A engenharia algorítmica da plataforma cria uma \'zona cinzenta\' premeditada entre o ganho real retido na fonte ' + 'e o valor reportado em SAF-T/DAC7. Este diferencial não declarado fica num limbo contabilístico, caracterizando ' + 'uma tipologia de criminalidade de colarinho branco e evasão fiscal estruturada, explorando a assimetria de ' + 'informação contra o parceiro e o Estado.' : 'The algorithmic engineering of the platform creates a premeditated \'grey zone\' between the real gain withheld at source ' + 'and the value reported in SAF-T/DAC7. This undeclared differential remains in an accounting limbo, characterizing ' + 'a typology of white-collar crime and structured tax evasion, exploiting information asymmetry ' + 'against the partner and the State.', _ccbW - 3);
			doc.text(_ccbLines, left + 3, y);
			y += (_ccbLines.length * 4) + 6;
		}
		if(y > 220) {
			addFooter(doc, pageNumber);
			doc.addPage();
			...
			y += 6;
			doc.setFont('helvetica', 'normal');
			const _bopTech = doc.splitTextToSize(currentLang === 'pt' ? 'Análise Técnica: A UNIFED-PROBATUM identificou uma divergência estrutural entre o Fluxo de Caixa Real ' + '(Ledger) e o Reporte Fiscal (SAF-T/DAC7). Dado que a plataforma detém o Monopólio da Emissão Documental ' + '(Art. 36.º, n.º 11 do CIVA) e o controlo exclusivo sobre o algoritmo de cálculo de comissões, o parceiro ' + 'encontra-se numa situação de indefesa técnica. A plataforma atua como "Black Box" fiscal — o sujeito ' + 'passivo não tem acesso ao código-fonte nem aos logs brutos de transação que geram a faturação delegada.' : 'Technical Analysis: UNIFED-PROBATUM identified a structural divergence between the Real Cash Flow ' + '(Ledger) and the Tax Reporting (SAF-T/DAC7). Given that the platform holds the Monopoly of Document Issuance ' + '(Art. 36(11) CIVA) and exclusive control over the commission calculation algorithm, the partner ' + 'finds themselves in a situation of technical defenselessness. The platform acts as a tax "Black Box" — the taxpayer ' + 'has no access to the source code nor to the raw transaction logs that generate the delegated invoicing.', _bopW - 3);
			doc.text(_bopTech, left + 3, y);
			y += (_bopTech.length * 4) + 4;
			doc.setFont('helvetica', 'bold');
			doc.setTextColor(10, 70, 10);
			const _bopConc = doc.splitTextToSize(currentLang === 'pt' ? 'Conclusão Pericial: Por força do Princípio da Proximidade da Prova (Acórdão STJ 11/07/2013) e do ' + 'Art. 344.º n.º 2 do CC, opera-se a Inversão do Ónus da Prova: incumbe à plataforma demonstrar a ' + 'integridade dos valores retidos (' + formatCurrency(cross.discrepanciaCritica) + '), sob pena de ' + 'confissão implícita da apropriação indevida e da fraude fiscal aqui evidenciada. ' + 'Cabe à Plataforma — e não ao sujeito passivo — provar a inexistência de dolo na retenção apurada.' : 'Expert Conclusion: By virtue of the Principle of Proximity of Evidence (STJ Judgment 11/07/2013) and ' + 'Art. 344(2) CC, the Reversal of the Burden of Proof occurs: it is incumbent upon the platform to demonstrate the ' + 'integrity of the amounts withheld (' + formatCurrency(cross.discrepanciaCritica) + '), under penalty of ' + 'implied confession of the improper appropriation and tax fraud evidenced herein. ' + 'It is up to the Platform — and not to the taxpayer — to prove the absence of intent in the retention found.', _bopW - 3);
			doc.setFont('helvetica', 'bold');
			doc.setTextColor(0, 0, 0);
			doc.text(_bopConc, left + 3, y);
			y += (_bopConc.length * 4) + 6;
		}
		addFooter(doc, pageNumber);
		if(_enrichSankeyImage) {
			doc.addPage();
			...
			doc.setFont('helvetica', 'bold');
			doc.setTextColor(0, 229, 255);
			doc.text(`${currentLang === 'pt' ? 'DIAGRAMA DE FLUXO FINANCEIRO — MONEY FLOW ANALYSIS · v13.5.0-PURE' : 'FINANCIAL FLOW DIAGRAM — MONEY FLOW ANALYSIS · v13.5.0-PURE'}`, doc.internal.pageSize.getWidth() / 2, 18, {
				align: 'center'
			});
			doc.setTextColor(0, 0, 0);
			y = 30;
			...
			doc.setFont('helvetica', 'italic');
			doc.setTextColor(80, 80, 80);
			const sankeyNotaLines = doc.splitTextToSize(currentLang === 'pt' ? 'Este diagrama representa o fluxo financeiro reconstituído a partir das evidências forenses carregadas (SAF-T, Extratos, DAC7). ' + 'É gerado em memória durante o processo de exportação e não altera o Dashboard nem as fórmulas de auditoria. ' + 'Constitui evidência visual do "caminho do dinheiro" para efeitos do Art. 125.º CPP.' : 'This diagram represents the financial flow reconstructed from the loaded forensic evidence (SAF-T, Statements, DAC7). ' + 'It is generated in memory during the export process and does not alter the Dashboard or the audit formulas. ' + 'It constitutes visual evidence of the "path of money" for the purposes of Art. 125 CPP.', doc.internal.pageSize.getWidth() - 28);
			...
			doc.setFont('helvetica', 'bold');
			doc.setTextColor(239, 68, 68);
			doc.text(`${currentLang === 'pt' ? 'VALORES CRÍTICOS APURADOS:' : 'CRITICAL VALUES FOUND:'}`, left, y);
			y += 4;
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(7);
			doc.setTextColor(0, 0, 0);
			if(cross.ivaFalta > 0) {
				doc.text(`  · ${currentLang === 'pt' ? 'IVA 23% omitido:' : 'Missing VAT 23%:'} ${formatCurrency(cross.ivaFalta)}`, left, y);
				y += 4;
			}
			if(cross.ivaFalta6 > 0) {
				doc.text(`  · ${currentLang === 'pt' ? 'IVA 6% omitido:' : 'Missing VAT 6%:'} ${formatCurrency(cross.ivaFalta6)}`, left, y);
				y += 4;
			}
			if(cross.discrepanciaSaftVsDac7 > 0) {
				doc.text(`  · ${currentLang === 'pt' ? 'Omissão de receita (SAF-T vs DAC7):' : 'Revenue omission (SAF-T vs DAC7):'} ${formatCurrency(cross.discrepanciaSaftVsDac7)}`, left, y);
				y += 4;
			}
			if(cross.discrepanciaCritica > 0) {
				doc.text(`  · ${currentLang === 'pt' ? 'Omissão de custos (BTF):' : 'Expense omission (BTF):'} ${formatCurrency(cross.discrepanciaCritica)} (${_pctOmissaoStr})`, left, y);
				y += 4;
			}
			if(cross.ircEstimado > 0) {
				doc.text(`  · ${currentLang === 'pt' ? 'IRC estimado omitido:' : 'Estimated omitted IRC:'} ${formatCurrency(cross.ircEstimado)}`, left, y);
				y += 4;
			}
			doc.setFontSize(6);
			doc.setFont('courier', 'normal');
		...
		if(_enrichTemporalImage) {
			...
			doc.setFont('helvetica', 'bold');
			doc.setTextColor(0, 229, 255);
			const _atfHeader = doc.splitTextToSize(currentLang === 'pt' ? 'ANÁLISE TEMPORAL FORENSE (ATF) — TENDÊNCIAS · OUTLIERS 2σ · ÍNDICE DE RECIDIVA · v13.5.0-PURE' : 'FORENSIC TEMPORAL ANALYSIS (ATF) — TRENDS · OUTLIERS 2σ · RECIDIVISM INDEX · v13.5.0-PURE', 180);
			doc.text(_atfHeader, doc.internal.pageSize.getWidth() / 2, 18, {
				align: 'center'
			});
			doc.setTextColor(0, 0, 0);
			y = 30;
			...
			doc.setFont('helvetica', 'italic');
			doc.setTextColor(80, 80, 80);
			const atfNota = doc.splitTextToSize(currentLang === 'pt' ? 'Gráfico temporal derivado dos extratos mensais processados. ' + 'Outliers marcados a vermelho (> 2σ) indicam meses com anomalia estatística — ' + 'constitui indício de comportamento oportunístico para efeitos do Art. 104.º RGIT.' : 'Temporal graph derived from processed monthly statements. ' + 'Outliers marked in red (> 2σ) indicate months with statistical anomaly — ' + 'constitutes evidence of opportunistic behavior for the purposes of Art. 104 RGIT.', 180);
			...
			if(typeof window.computeTemporalAnalysis === 'function') {
				try {
					...
					doc.setFont('helvetica', 'bold');
					doc.setTextColor(239, 68, 68);
					doc.text(`${currentLang === 'pt' ? 'SCORE DE PERSISTÊNCIA (SP):' : 'PERSISTENCE SCORE (SP):'} ${_atfData.persistenceScore.toFixed(1)}/100`, left, y);
					y += 5;
					doc.setFont('helvetica', 'normal');
					doc.setFontSize(7.5);
					doc.setTextColor(0, 0, 0);
					doc.text(_atfData.persistenceLabel, left, y);
					y += 4;
					if(_atfData.outlierMonths.length > 0) {
						doc.setTextColor(239, 68, 68);
						doc.text(`${currentLang === 'pt' ? 'Meses com Outlier (>2σ):' : 'Months with Outlier (>2σ):'} ${_atfData.outlierMonths.join(', ')}`, left, y);
						y += 4;
						doc.setTextColor(0, 0, 0);
					}
					doc.setFontSize(6.5);
		...
		if(_enrichLegalNarrative) {
			...
			doc.setFont('helvetica', 'bold');
			doc.setTextColor(0, 229, 255);
			doc.text(`${currentLang === 'pt' ? 'SÍNTESE JURÍDICA PERICIAL — ANÁLISE DETERMINÍSTICA v13.5.0-PURE' : 'FORENSIC LEGAL SUMMARY — DETERMINISTIC ANALYSIS v13.5.0-PURE'}`, doc.internal.pageSize.getWidth() / 2, 18, {
				align: 'center'
			});
			doc.setTextColor(0, 0, 0);
			y = 30;
			...
			doc.setFont('helvetica', 'italic');
			doc.setTextColor(80, 80, 80);
			const aiNotaLines = doc.splitTextToSize(currentLang === 'pt' ? 'Documento gerado sob metodologia forense UNIFED-PROBATUM v13.5.0-PURE. ' + 'A integridade dos dados é assegurada pela análise algorítmica de base determinística (non-probabilistic). ' + 'Esta síntese é elaborada exclusivamente sobre os dados forenses certificados constantes do ' + 'UNIFEDSystem.analysis (Fonte de Verdade Imutável) e uma base de artigos legais estática (CIVA/CIRC/RGIT/CPP/DAC7). ' + 'Conformidade: Art. 125.º CPP · ISO/IEC 27037:2012 · DORA (UE) 2022/2554.' : 'Document generated under UNIFED-PROBATUM v13.5.0-PURE forensic methodology. ' + 'Data integrity is ensured by deterministic algorithmic analysis (non-probabilistic). ' + 'This summary is prepared exclusively on the certified forensic data contained in ' + 'UNIFEDSystem.analysis (Immutable Truth Source) and a static legal article base (CIVA/CIRC/RGIT/CPP/DAC7). ' + 'Compliance: Art. 125 CPP · ISO/IEC 27037:2012 · DORA (EU) 2022/2554.', doc.internal.pageSize.getWidth() - 28);
			...
			const narrativeLines = doc.splitTextToSize(_enrichLegalNarrative, doc.internal.pageSize.getWidth() - 28);
			...
			doc.setFont('courier', 'normal');
			doc.setTextColor(100, 116, 139);
			doc.text('UNIFED-PROBATUM v13.5.0-PURE · Análise Determinística · Base Legal: CIVA/CIRC/RGIT/CPP/DAC7', left, y);
			y += 4;
			...
			doc.setFontSize(6.5);
			doc.setTextColor(80, 80, 80);
			const jurNota = doc.splitTextToSize(currentLang === 'pt' ? 'NOTA: A jurisprudência citada nesta síntese constitui referência doutrinária para orientação do advogado mandatário. ' + 'Toda a referência a acórdãos deve ser objeto de validação independente pelo advogado antes de qualquer uso processual. ' + 'O Consultor Técnico responsabiliza-se exclusivamente pelos dados forenses e pela metodologia UNIFED-PROBATUM.' : 'NOTE: The jurisprudence cited in this summary constitutes doctrinal reference for guidance of the lawyer in charge. ' + 'Any reference to judgments must be subject to independent validation by the lawyer before any procedural use. ' + 'The Technical Consultant is solely responsible for the forensic data and the UNIFED-PROBATUM methodology.', doc.internal.pageSize.getWidth() - 28);
			doc.text(jurNota, left, y);
			y += jurNota.length * 3.5;
			addFooter(doc, pageNumber);
		}
		doc.addPage();
		pageNumber = 6;
		...
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(8);
		doc.text(`${currentLang === 'pt' ? 'Master Hash: SHA256(Hash_SAFT + Hash_Extrato + Hash_Fatura)' : 'Master Hash: SHA256(Hash_SAFT + Hash_Statement + Hash_Invoice)'}`, left, y);
		y += 5;
		...
		doc.text(masterHashLines, left, y);
		y += (masterHashLines.length * 4) + 10;
		doc.setFont('helvetica', 'normal');
		doc.setTextColor(0, 0, 0);
		doc.setFontSize(8);
		doc.text(`${currentLang === 'pt' ? 'REFERENCIAL NORMATIVO (ISO/IEC 27037 e DL 28/2019):' : 'NORMATIVE FRAMEWORK (ISO/IEC 27037 and DL 28/2019):'}`, left, y);
		y += 5;
		doc.setFont('helvetica', 'normal');
		const normativoLines = doc.splitTextToSize(t.clausulaNormativoISO, doc.internal.pageSize.getWidth() - 30);
		doc.text(normativoLines, left, y);
		y += (normativoLines.length * 4) + 10;
		doc.text(`${currentLang === 'pt' ? 'Evidencias processadas e respetivos hashes SHA-256 completos:' : 'Processed evidence and their complete SHA-256 hashes:'}`, left, y);
		y += 5;
		...
		UNIFEDSystem.analysis.evidenceIntegrity.forEach((item, index) => {
			...
			doc.setFontSize(7);
			doc.setTextColor(0, 0, 0);
			const displayName = item.filename.length > 50 ? item.filename.substring(0, 47) + '...' : item.filename;
			doc.text(`${index + 1}. ${displayName}`, left, y);
			y += 4;
			doc.setFont('courier', 'normal');
			doc.setFontSize(6.5);
		...
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(8);
		doc.text(`${currentLang === 'pt' ? 'Protocolo de Carimbo de Tempo Qualificado conforme Regulamento eIDAS (UE) 910/2014 e RFC 3161 (IETF).' : 'Qualified Timestamp Protocol according to eIDAS Regulation (EU) 910/2014 and RFC 3161 (IETF).'}`, left, y, {
			maxWidth: doc.internal.pageSize.getWidth() - 30
		});
		y += 8;
		...
		doc.setFont('helvetica', 'bold');
		doc.setFontSize(8);
		doc.text(`${currentLang === 'pt' ? 'DETALHES DO PROTOCOLO RFC 3161 (TimeStampToken):' : 'RFC 3161 PROTOCOL DETAILS (TimeStampToken):'}`, left, y);
		y += 6;
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(7.5);
		const rfc3161Details = [
			...
			currentLang === 'pt' ? 'para obtenção de provas de existência temporal com validade jurídica (non-repudiation).' : 'for obtaining proof of temporal existence with legal validity (non-repudiation).', '', `• ${currentLang === 'pt' ? 'A TSA (Time Stamping Authority) recebe o hash SHA-256 do documento/prova.' : 'The TSA (Time Stamping Authority) receives the SHA-256 hash of the document/evidence.'}`, `• ${currentLang === 'pt' ? 'Gera um TimeStampToken (TST) assinado digitalmente com o certificado X.509 da TSA.' : 'Generates a TimeStampToken (TST) digitally signed with the TSA\'s X.509 certificate.'}`, `• ${currentLang === 'pt' ? 'O TST inclui: hash, data/hora UTC certificada e número de série imutável.' : 'The TST includes: hash, certified UTC date/time and immutable serial number.'}`, `• ${currentLang === 'pt' ? 'Validade jurídica: eIDAS (UE) 910/2014, Art. 41.º — Serviço de Carimbo de Tempo Qualificado.' : 'Legal validity: eIDAS (EU) 910/2014, Art. 41 — Qualified Timestamp Service.'}`, '', `${currentLang === 'pt' ? 'CONFORMIDADE NORMATIVA ACUMULADA:' : 'ACCUMULATED NORMATIVE COMPLIANCE:'}`, `  • eIDAS (UE) 910/2014 — ${currentLang === 'pt' ? 'Serviço Eletrónico de Confiança Qualificado' : 'Qualified Electronic Trust Service'}`, `  • RFC 3161 (IETF) — ${currentLang === 'pt' ? 'Protocolo de Carimbo de Tempo Internet PKI' : 'Internet PKI Timestamp Protocol'}`, `  • ISO/IEC 27037:2012 — ${currentLang === 'pt' ? 'Diretrizes para Identificação e Recolha de Provas Digitais' : 'Guidelines for Identification and Collection of Digital Evidence'}`, `  • DORA (UE) 2022/2554 — ${currentLang === 'pt' ? 'Resiliência Operacional Digital do Sector Financeiro' : 'Digital Operational Resilience of the Financial Sector'}`, `  • Art. 30.º RGPD — ${currentLang === 'pt' ? 'Registo das Atividades de Tratamento de Dados Pessoais' : 'Record of Personal Data Processing Activities'}`
		];
		...
		doc.setFont('helvetica', 'bold');
		doc.setFontSize(8);
		doc.text(`${currentLang === 'pt' ? 'STATUS DE SELAGEM POR EVIDÊNCIA:' : 'SEALING STATUS PER EVIDENCE:'}`, left, y);
		y += 6;
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(7);
		...
		if(questionsToShow.length < 10) {
			...
			const additional = QUESTIONS_CACHE.filter(q => !questionsToShow.some(sq => sq.id === q.id)).sort((a, b) => (PRIORITY_ORDER[a.type] ?? 2) - (PRIORITY_ORDER[b.type] ?? 2)).slice(0, 10 - questionsToShow.length);
		...
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(9);
		doc.text(t.pdfConclusionText, left, y, {
			maxWidth: doc.internal.pageSize.getWidth() - 30
		});
		y += 15;
		doc.setTextColor(239, 68, 68);
		doc.setFontSize(11);
		doc.text(`VI. ${currentLang === 'pt' ? 'CONCLUSÃO:' : 'CONCLUSION:'}`, left, y);
		y += 8;
		doc.setTextColor(0, 0, 0);
		doc.text(`${currentLang === 'pt' ? 'Indícios de infração ao Artigo 108.º do Código do IVA e não conformidade com o Decreto-Lei n.º 28/2019.' : 'Evidence of violation of Article 108 of the VAT Code and non-compliance with Decree-Law No. 28/2019.'}`, left, y);
		y += 6;
		if(!UNIFEDSystem.demoMode && !UNIFEDSystem.casoRealAnonimizado) {
			doc.setFontSize(9);
			doc.setFont('helvetica', 'bold');
			doc.setTextColor(0, 0, 0);
			doc.text(`${currentLang === 'pt' ? 'PARECER TÉCNICO DE CONCLUSÃO:' : 'TECHNICAL EXPERT OPINION CONCLUSION:'}`, left, y);
			y += 6;
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			const parecerFinalLines = doc.splitTextToSize(t.parecerTecnicoFinal, doc.internal.pageSize.getWidth() - 30);
			doc.text(parecerFinalLines, left, y);
			y += (parecerFinalLines.length * 4) + 10;
			doc.setFontSize(9);
			doc.setFont('helvetica', 'bold');
			doc.setTextColor(0, 0, 0);
			doc.text(`${currentLang === 'pt' ? 'DECLARAÇÃO DE ISENÇÃO DE RESPONSABILIDADE DO PARCEIRO:' : 'PARTNER LIABILITY DISCLAIMER:'}`, left, y);
			y += 6;
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			const isencaoLines = doc.splitTextToSize(t.clausulaIsencaoParceiro, doc.internal.pageSize.getWidth() - 30);
			doc.text(isencaoLines, left, y);
			y += (isencaoLines.length * 4) + 10;
		}
		doc.setFontSize(9);
		doc.setFont('helvetica', 'bold');
		doc.setTextColor(0, 0, 0);
		doc.text(`${currentLang === 'pt' ? 'VALIDAÇÃO TÉCNICA DE CONSULTORIA:' : 'TECHNICAL CONSULTANCY VALIDATION:'}`, left, y);
		y += 6;
		doc.setFont('helvetica', 'normal');
		doc.setFontSize(8);
		const assinaturaLines = doc.splitTextToSize(t.clausulaAssinaturaDigital, doc.internal.pageSize.getWidth() - 30);
		doc.text(assinaturaLines, left, y);
		y += (assinaturaLines.length * 4) + 10;
		if(_auxTotalNS > 0) {
			if(y > 220) {
				doc.addPage();
				pageNumber++;
			...
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			const dac7Body1 = doc.splitTextToSize(currentLang === 'pt' ? 'A diferença entre os Ganhos Brutos reportados pelo extrato da plataforma e o ' + 'valor comunicado à AT via DAC7 inclui fluxos que não estão sujeitos a comissão ' + 'pela plataforma (Termos e Condições). Estes valores — gorjetas dos passageiros, ganhos de ' + 'campanha e portagens — são transferências diretas ou reembolsos operacionais ' + 'que não integram a base de cálculo da comissão, mas podem ter sido ' + 'indevidamente incluídos no reporte DAC7, inflacionando o rendimento bruto ' + 'declarado à Autoridade Tributária (AT).' : 'The difference between the Gross Earnings reported by the platform statement and the ' + 'value communicated to the TA via DAC7 includes flows that are not subject to commission ' + 'by the platform (Terms and Conditions). These values — passenger tips, campaign earnings ' + 'and tolls — are direct transfers or operational reimbursements ' + 'that are not part of the commission calculation basis, but may have been ' + 'improperly included in the DAC7 report, inflating the gross income ' + 'declared to the Tax Authority (TA).', dac7UseW);
			doc.text(dac7Body1, left, y);
			y += (dac7Body1.length * 4.5) + 5;
			doc.setFont('helvetica', 'bold');
			doc.setFontSize(8);
			doc.setTextColor(30, 60, 120);
			doc.text(`${currentLang === 'pt' ? 'FLUXOS NÃO SUJEITOS A COMISSÃO (Termos e Condições da Plataforma — 0%)' : 'FLOWS NOT SUBJECT TO COMMISSION (Platform Terms and Conditions — 0%)'}`, left, y);
			y += 5;
			doc.setTextColor(0, 0, 0);
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			const auxRows = [{
				label: currentLang === 'pt' ? 'Ganhos da campanha (Campanhas)' : 'Campaign Earnings (Campaigns)',
				val: _aux.campanhas || 0,
				note: currentLang === 'pt' ? '0% comissão · incentivo plataforma' : '0% commission · platform incentive'
			}, {
				label: currentLang === 'pt' ? 'Gorjetas dos passageiros (Tips)' : 'Passenger Tips (Tips)',
				val: _aux.gorjetas || 0,
				note: currentLang === 'pt' ? '0% comissão · transferência P2P' : '0% commission · P2P transfer'
			}, {
				...
				val: _aux.portagens || 0,
				note: currentLang === 'pt' ? 'reembolso operacional' : 'operational reimbursement'
			}, {
				label: currentLang === 'pt' ? 'Taxas de Cancelamento' : 'Cancellation Fees',
				val: _aux.cancelamentos || 0,
				note: currentLang === 'pt' ? 'já incluído em Despesas — Sujeito a Comissão' : 'already included in Expenses — Subject to Commission'
			}, ];
			auxRows.forEach(row => {
				if(row.val === 0) return;
			...
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			const dac7Impact = doc.splitTextToSize(currentLang === 'pt' ? `Impacto DAC7: Os ${formatCurrency(_auxTotalNS)} de fluxos não sujeitos a ` + 'comissão não justificam a totalidade da discrepância entre o extrato da ' + `plataforma (${formatCurrency(totals.ganhos)}) e o valor DAC7 reportado ` + `à AT (${formatCurrency(totals.dac7TotalPeriodo)}), porquanto a divergência apurada é materialmente superior. ` + 'Se incluídos indevidamente no rendimento bruto DAC7, o contribuinte terá sido prejudicado na determinação ' + 'da sua base tributável.' : `DAC7 Impact: The ${formatCurrency(_auxTotalNS)} of flows not subject to ` + 'commission do not justify the entirety of the discrepancy between the platform ' + `statement (${formatCurrency(totals.ganhos)}) and the DAC7 value reported ` + `to the TA (${formatCurrency(totals.dac7TotalPeriodo)}), as the divergence found is materially greater. ` + 'If improperly included in the DAC7 gross income, the taxpayer will have been harmed in the determination ' + 'of their taxable base.', dac7UseW);
			doc.text(dac7Impact, left, y);
			y += (dac7Impact.length * 4.5) + 5;
			if(y > 240) {
				doc.addPage();
				pageNumber++;
				y = 20;
			...
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			const contraditorio = doc.splitTextToSize(currentLang === 'pt' ? `Os valores isentos de comissão (Campanhas + Gorjetas + ${UNIFEDSystem.selectedYear >= 2025 ? 'Reembolsos/Portagens' : 'Portagens'} = ` + `${formatCurrency(_auxTotalNS)}) foram indevidamente incluídos no cálculo ` + 'do rendimento bruto para efeitos de reporte SAF-T / DAC7? ' + 'Se sim, porque é que foi aplicada uma presunção de rendimento sobre valores ' + 'que, pelos Termos e Condições da plataforma para TVDE, não sofrem retenção nem comissão por parte da mesma?' : `Were the commission-exempt values (Campaigns + Tips + ${UNIFEDSystem.selectedYear >= 2025 ? 'Reimbursements/Tolls' : 'Tolls'} = ` + `${formatCurrency(_auxTotalNS)}) improperly included in the calculation ` + 'of gross income for SAF-T / DAC7 reporting purposes? ' + 'If so, why was a presumption of income applied to values ' + 'that, under the Terms and Conditions of the TVDE platform, are not subject to withholding or commission by the platform?', dac7UseW - 5);
			doc.text(contraditorio, left + 3, y);
			y += (contraditorio.length * 4.5) + 5;
			doc.setFont('helvetica', 'bold');
			doc.setFontSize(7.5);
			doc.setTextColor(239, 68, 68);
			const qLegal = doc.splitTextToSize(currentLang === 'pt' ? '[Fundamentação Legal] Termos e Condições da Plataforma · Comissões 0% sobre gorjetas e campanhas · ' + 'Art. 125.º CPP (admissibilidade da prova) · Art. 103.º RGIT (Fraude Fiscal) · ' + 'DAC7 / Diretiva (UE) 2021/514 · AT — Autoridade Tributária e Aduaneira' : '[Legal Basis] Platform Terms and Conditions · 0% commission on tips and campaigns · ' + 'Art. 125 CPP (admissibility of evidence) · Art. 103 RGIT (Tax Fraud) · ' + 'DAC7 / Directive (EU) 2021/514 · TA — Tax and Customs Authority', dac7UseW - 5);
			...
			if(percDiscrepancia > 15) {
				...
				doc.text(`${currentLang === 'pt' ? `[!] ALERTA DE DESVIO CRITICO (${percDiscrepancia.toFixed(2)}%) - INVERSAO DO ONUS DA PROVA` : `[!] CRITICAL DEVIATION ALERT (${percDiscrepancia.toFixed(2)}%) - REVERSAL OF BURDEN OF PROOF`}`, left + 3, y + 5);
				doc.setFont('helvetica', 'normal');
				doc.setFontSize(8);
				doc.setTextColor(80, 0, 0);
				const _invTexto = doc.splitTextToSize(currentLang === 'pt' ? 'Dada a discrepância material superior a 15% entre o rendimento real extraído dos documentos ' + 'da plataforma e o reporte oficial comunicado à Autoridade Tributária (AT) via SAF-T/DAC7, ' + 'verificam-se os pressupostos legais para a Inversão do Ónus da Prova, nos termos do ' + 'Art. 344.º do Código Civil e Art. 74.º/75.º da Lei Geral Tributária (LGT). ' + 'Cabe à entidade processadora (Plataforma) o ónus de elidir a presunção de omissão de ' + 'rendimentos aqui documentada, sob pena de cristalização da prova material apresentada. ' + 'A discrepância apurada ultrapassa igualmente os limiares das manifestações de fortuna ' + '(Art. 89.º-A LGT), podendo fundamentar avaliação indireta da matéria coletável.' : 'Given the material discrepancy exceeding 15% between the real income extracted from the ' + 'platform documents and the official report communicated to the Tax Authority (TA) via SAF-T/DAC7, ' + 'the legal assumptions for the Reversal of the Burden of Proof are met, under the terms of ' + 'Art. 344 of the Civil Code and Art. 74/75 of the General Tax Law (LGT). ' + 'It is incumbent upon the processing entity (Platform) to rebut the presumption of omission of ' + 'income documented herein, under penalty of crystallization of the material evidence presented. ' + 'The discrepancy found also exceeds the thresholds for manifestations of fortune ' + '(Art. 89-A LGT), which may support indirect assessment of the taxable base.', _invW - 6);
				doc.text(_invTexto, left + 3, y + 11);
				y += 38;
				doc.setTextColor(0, 0, 0);
				doc.setFont('helvetica', 'italic');
				doc.setFontSize(6.5);
				doc.text(currentLang === 'pt' ? 'Fundamento: Art. 344.º CC · Art. 74.º/75.º LGT · Art. 89.º-A LGT · Art. 103.º/104.º RGIT' : 'Basis: Art. 344 CC · Art. 74/75 LGT · Art. 89-A LGT · Art. 103/104 RGIT', left, y);
				y += 7;
				doc.setFont('helvetica', 'normal');
			}
		}
		if(y > 240) {
			...
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(7.5);
			const _cqIntro = doc.splitTextToSize(currentLang === 'pt' ? 'As seguintes questões, elaboradas com fundamento pericial, destinam-se a ser formuladas ao representante legal da plataforma ' + 'em sede de audiência de discussão e julgamento, nos termos do Art. 327.º do CPP (Contraditório). ' + 'Cada questão sustenta-se em evidência digital auditada e documentada no presente relatório forense.' : 'The following questions, prepared based on expert findings, are intended to be put to the legal representative of the platform ' + 'during the hearing for discussion and judgment, under the terms of Art. 327 CPP (Contradiction). ' + 'Each question is supported by audited and documented digital evidence in this forensic report.', _cqUseW);
			doc.text(_cqIntro, left, y);
			y += (_cqIntro.length * 3.5) + 6;
			doc.setFont('helvetica', 'bold');
			doc.setFontSize(8);
			doc.setTextColor(30, 60, 120);
			doc.text(`${currentLang === 'pt' ? 'Q1 — DESALINHAMENTO TEMPORAL (Pagamento Semanal vs Faturação Mensal):' : 'Q1 — TEMPORAL MISMATCH (Weekly Payment vs Monthly Invoicing):'}`, left, y);
			y += 5;
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			doc.setTextColor(0, 0, 0);
			const _cqQ1 = doc.splitTextToSize(currentLang === 'pt' ? '"Pode a plataforma explicar a impossibilidade de reconciliação bancária direta (cruzamento 1:1) ' + 'resultante do desalinhamento temporal entre o processamento de pagamentos — efectuado semanalmente ' + 'por transferência bancária — e a emissão dos documentos de reporte fiscal, efectuada em formato ' + 'mensal agregado? Esta assimetria temporal, detetada pelo sistema UNIFED-PROBATUM, impede o parceiro ' + 'de auditar as transferências recebidas contra o documento de reporte correspondente, constituindo ' + 'indício de ofuscação deliberada, nos termos do Art. 103.º do RGIT."' : '"Can the platform explain the impossibility of direct bank reconciliation (1:1 matching) ' + 'resulting from the temporal misalignment between the processing of payments — made weekly ' + 'by bank transfer — and the issuance of tax reporting documents, made in aggregate ' + 'monthly format? This temporal asymmetry, detected by the UNIFED-PROBATUM system, prevents the partner ' + 'from auditing the transfers received against the corresponding reporting document, constituting ' + 'evidence of deliberate obfuscation, under the terms of Art. 103 of the RGIT."', _cqUseW - 5);
			doc.text(_cqQ1, left + 3, y);
			y += (_cqQ1.length * 3.5) + 7;
			if(y > 245) {
				doc.addPage();
				pageNumber++;
				y = 20;
			...
			doc.setFontSize(8);
			doc.setTextColor(30, 60, 120);
			doc.text(`${currentLang === 'pt' ? 'Q2 — INCLUSÃO DE FLUXOS ISENTOS NO REPORTE DAC7 (Lei TVDE · Diretiva UE 2021/514):' : 'Q2 — INCLUSION OF EXEMPT FLOWS IN DAC7 REPORT (TVDE Law · Directive EU 2021/514):'}`, left, y);
			y += 5;
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			doc.setTextColor(0, 0, 0);
			const _cqQ2 = doc.splitTextToSize(currentLang === 'pt' ? '"Qual o fundamento legal e contratual que suporta a inclusão de fluxos financeiros não sujeitos a comissão — ' + 'gorjetas, campanhas e portagens — no valor bruto reportado via DAC7? Embora a Lei TVDE regule a ' + 'atividade, a isenção de comissão sobre estes valores está vinculada estritamente aos Termos e Condições ' + 'da Plataforma. A inclusão destes montantes no reporte da AT, sem a devida segregação de fluxos não ' + 'remuneratórios (cfr. Art. 36.º, n.º 11 do CIVA), pode constituir uma deficiência na extração de dados ' + 'do sistema de informação da plataforma, resultando num reporte fiscalmente inexato."' : '"What is the legal and contractual basis that supports the inclusion of financial flows not subject to commission — ' + 'tips, campaigns and tolls — in the gross value reported via DAC7? Although the TVDE Law regulates the ' + 'activity, the exemption of commission on these values is strictly linked to the Terms and Conditions ' + 'of the Platform. The inclusion of these amounts in the report to the TA, without the proper segregation of non-remunerative ' + 'flows (cf. Art. 36(11) CIVA), may constitute a deficiency in the extraction of data ' + 'from the platform\'s information system, resulting in an inaccurate tax report."', _cqUseW - 5);
			doc.text(_cqQ2, left + 3, y);
			y += (_cqQ2.length * 3.5) + 7;
			doc.setFont('helvetica', 'italic');
			doc.setFontSize(6.5);
			doc.setTextColor(100, 100, 100);
			const _cqNota = doc.splitTextToSize(currentLang === 'pt' ? 'Fundamentação Legal: Art. 327.º CPP (Contraditório) · Art. 125.º CPP (Admissibilidade de Prova) · ' + 'Art. 103.º/104.º RGIT (Fraude Fiscal/Qualificada) · Art. 36.º, n.º 11 CIVA · ' + 'Decreto-Lei n.º 28/2019 (SAF-T/DAC7) · Diretiva (UE) 2021/514 (DAC7) · ' + 'Termos e Condições da Plataforma · ISO/IEC 27037:2012 (prova digital)' : 'Legal Basis: Art. 327 CPP (Contradiction) · Art. 125 CPP (Admissibility of Evidence) · ' + 'Art. 103/104 RGIT (Tax Fraud/Qualified) · Art. 36(11) CIVA · ' + 'Decree-Law No. 28/2019 (SAF-T/DAC7) · Directive (EU) 2021/514 (DAC7) · ' + 'Platform Terms and Conditions · ISO/IEC 27037:2012 (digital evidence)', _cqUseW);
			doc.text(_cqNota, left, y);
			y += (_cqNota.length * 3) + 6;
			doc.setTextColor(0, 0, 0);
			doc.setFont('helvetica', 'normal');
		}
		if(y > 50) {
			...
			doc.setFontSize(9);
			doc.setTextColor(0, 0, 0);
			doc.text(`${currentLang === 'pt' ? 'TERMO DE ENCERRAMENTO — CONSULTORIA FORENSE' : 'CLOSING TERM — FORENSIC CONSULTANCY'}`, left, y);
			y += 7;
			const _totalPaginasTermo = doc.internal.getNumberOfPages();
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			doc.setTextColor(0, 0, 0);
			const _termoTextoIntro = doc.splitTextToSize(currentLang === 'pt' ? `O presente relatório é composto por ${_totalPaginasTermo} páginas, todas rubricadas digitalmente e seladas com o Master Hash de integridade:` : `This report consists of ${_totalPaginasTermo} pages, all digitally initialed and sealed with the Master Integrity Hash:`, _termUW);
			doc.text(_termoTextoIntro, left, y);
			y += (_termoTextoIntro.length * 4) + 2;
			doc.setFont('courier', 'normal');
			doc.setFontSize(6);
			doc.setTextColor(0, 0, 0);
			const _hashLines = doc.splitTextToSize(_termMH, _termUW);
			doc.text(_hashLines, left, y);
			y += (_hashLines.length * 3.5) + 4;
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(8);
			doc.setTextColor(0, 0, 0);
			const _termoTextoCont = doc.splitTextToSize(currentLang === 'pt' ? 'constituindo Prova Digital Material inalterável para efeitos judiciais, sob égide do Art. 103.º do RGIT, normas ISO/IEC 27037 e Decreto-Lei n.º 28/2019.' : 'constituting unalterable Material Digital Evidence for judicial purposes, under the aegis of Art. 103 RGIT, ISO/IEC 27037 standards and Decree-Law No. 28/2019.', _termUW);
			doc.text(_termoTextoCont, left, y);
			y += (_termoTextoCont.length * 4) + 6;
			doc.setFont('helvetica', 'bold');
			doc.setFontSize(8);
			doc.setTextColor(30, 60, 120);
			doc.text(`${currentLang === 'pt' ? 'ADMISSIBILIDADE DA PROVA DIGITAL — Art. 125.º CPP' : 'ADMISSIBILITY OF DIGITAL EVIDENCE — Art. 125 CPP'}`, left, y);
			y += 5;
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(7.5);
			doc.setTextColor(0, 0, 0);
			const _cpp125Lines = doc.splitTextToSize(currentLang === 'pt' ? 'São admissíveis como meios de prova todos os meios não proibidos por lei (Art. 125.º do Código de Processo Penal Português). ' + 'O presente relatório pericial constitui Prova Digital Material, produzida com recurso a metodologia forense certificada (ISO/IEC 27037:2012), ' + 'integridade criptografica SHA-256 e cadeia de custodia documentada, sendo admissível perante as Instâncias Judiciais Competentes nos termos do Art. 125.º CPP ' + 'e do Art. 32.º da Constituição da República Portuguesa (Garantias de Defesa). ' + 'A omissão de IVA apurada fundamenta a qualificação do facto nos termos dos Art. 103.º (Fraude Fiscal) e Art. 104.º (Fraude Fiscal Qualificada) do RGIT.' : 'All means of proof not prohibited by law are admissible (Art. 125 of the Portuguese Code of Criminal Procedure). ' + 'This expert report constitutes Material Digital Evidence, produced using certified forensic methodology (ISO/IEC 27037:2012), ' + 'cryptographic integrity SHA-256 and documented chain of custody, being admissible before the Competent Judicial Authorities under the terms of Art. 125 CPP ' + 'and Art. 32 of the Constitution of the Portuguese Republic (Defense Guarantees). ' + 'The missing VAT found supports the qualification of the fact under the terms of Art. 103 (Tax Fraud) and Art. 104 (Qualified Tax Fraud) of the RGIT.', _termUW);
			doc.text(_cpp125Lines, left, y);
			y += (_cpp125Lines.length * 3.5) + 6;
			doc.setFont('helvetica', 'bold');
			doc.setFontSize(8);
			doc.setTextColor(30, 60, 120);
			doc.text(`${currentLang === 'pt' ? 'SELAGEM TEMPORAL RFC 3161 — DATA CERTA eIDAS:' : 'RFC 3161 TIMESTAMP SEAL — CERTIFIED DATE eIDAS:'}`, left, y);
			y += 5;
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(7.5);
			doc.setTextColor(0, 0, 0);
			const _rfc3161Lines = doc.splitTextToSize(currentLang === 'pt' ? 'Documento selado temporalmente via Protocolo RFC 3161 (TSA: FreeTSA.org), garantindo Data Certa eIDAS. ' + 'Os selos .tsr individuais de cada evidência encontram-se arquivados na pasta 03_REPOSITORIO_OTS.' : 'Document temporally sealed via RFC 3161 Protocol (TSA: FreeTSA.org), guaranteeing eIDAS Certified Date. ' + 'The individual .tsr seals for each evidence are archived in the 03_REPOSITORIO_OTS folder.', _termUW);
			doc.text(_rfc3161Lines, left, y);
			y += (_rfc3161Lines.length * 3.5) + 6; {
				...
				doc.setFontSize(8);
				doc.setTextColor(0, 0, 0);
				doc.text(`${currentLang === 'pt' ? 'CONSULTOR TÉCNICO — COMPROMISSO DE HONRA E SALVAGUARDA (ART. 153.º E 155.º CPP)' : 'TECHNICAL CONSULTANT — COMMITMENT OF HONOR AND SAFEGUARD (ART. 153 AND 155 CPP)'}`, left, y);
				y += 6;
				doc.setFont('helvetica', 'normal');
				doc.setFontSize(8);
				...
				doc.text(`${currentLang === 'pt' ? 'Identificação:' : 'Identification:'}`, left, y);
				y += 5;
				doc.text(`* ${currentLang === 'pt' ? 'Nome:' : 'Name:'}     ${_sigResponsavel}`, left, y);
				y += 5;
				doc.text(`* ${currentLang === 'pt' ? 'Cargo:' : 'Position:'}    ${_sigCargo}`, left, y);
				y += 5;
				const _sigRegLines = doc.splitTextToSize(`* ${currentLang === 'pt' ? 'Estatuto:' : 'Status:'} ${_sigRegisto}`, doc.internal.pageSize.getWidth() - left - 14);
				doc.text(_sigRegLines, left, y);
				y += (_sigRegLines.length * 4) + 3;
				const _sigNota = doc.splitTextToSize(currentLang === 'pt' ? 'NOTA DE SALVAGUARDA JURÍDICA E ÂMBITO: As conclusões constantes neste documento infraestruturam-se exclusivamente nos artefactos e elementos documentais disponibilizados pelo solicitante. O presente parecer constitui uma análise técnica independente de natureza consultiva e prova documental assistencial, não substituindo, para quaisquer efeitos processuais, a realização de uma perícia oficial ordenada pela autoridade judiciária competente.' : 'JURIDICAL SAFEGUARD AND SCOPE NOTE: The conclusions contained in this document are based exclusively on the artifacts and documentary elements made available by the requester. This opinion constitutes an independent technical analysis of a consultative nature and supporting documentary evidence, not replacing, for any procedural purposes, the carrying out of an official expertise ordered by the competent judicial authority.', _sigW);
				doc.text(_sigNota, left, y);
				y += (_sigNota.length * 3.5) + 3;
				const _sigLimit = doc.splitTextToSize(currentLang === 'pt' ? 'Análise material baseada em dados estruturados fornecidos; o escopo limita-se à integridade financeira e documental dos ativos digitais apresentados, conforme Art. 125.º CPP.' : 'Material analysis based on provided structured data; the scope is limited to the financial and documentary integrity of the presented digital assets, in accordance with Art. 125 CPP.', _sigW);
				doc.text(_sigLimit, left, y);
				y += (_sigLimit.length * 3.5) + 3;
				const _sigDecl = doc.splitTextToSize(currentLang === 'pt' ? 'DECLARAÇÃO DE COMPROMISSO: Declaro, sob compromisso de honra, que o presente parecer técnico foi elaborado na qualidade de Consultor Técnico Independente, assumindo estritamente os deveres de independência, objetividade e imparcialidade previstos no Artigo 153.º do Código de Processo Penal Português. Certifico que a metodologia aplicada (Baseada em ISRS 4400 e boas práticas de Digital Forensics) é reprodutível e que os resultados aqui vertidos traduzem fielmente a análise técnica realizada sobre o lote de dados fornecido.' : 'COMMITMENT DECLARATION: I declare, under a commitment of honor, that this technical opinion was prepared as an Independent Technical Consultant, strictly assuming the duties of independence, objectivity and impartiality provided for in Article 153 of the Portuguese Code of Criminal Procedure. I certify that the methodology applied (Based on ISRS 4400 and Digital Forensics best practices) is reproducible and that the results expressed herein faithfully reflect the technical analysis carried out on the provided data set.', _sigW);
				doc.text(_sigDecl, left, y);
				y += (_sigDecl.length * 3.8) + 4;
				doc.setDrawColor(0, 0, 0);
				doc.setLineWidth(0.3);
			...
			doc.setFontSize(9);
			doc.setTextColor(30, 60, 120);
			doc.text('[ UNIFED - PROBATUM CERTIFIED · ANALISTA E CONSULTOR FORENSE · v13.5.0-PURE ]', _termW / 2, y, {
				align: 'center'
			});
			y += 5;
			doc.setFont('helvetica', 'normal');
			doc.setFontSize(6.5);
			doc.setTextColor(80, 80, 80);
			doc.text(`${currentLang === 'pt' ? 'Estudo de Viabilidade · Consultoria Forense Especializada · Uso restrito a mandato jurídico autorizado' : 'Feasibility Study · Specialized Forensic Consultancy · Use restricted to authorized legal mandate'}`, _termW / 2, y, {
				align: 'center'
			});
			y += 4;
			doc.setFontSize(6);
			doc.text(`${currentLang === 'pt' ? 'Fundamentação: RGIT Art. 103.º (Fraude Fiscal) · Art. 104.º (Fraude Qualificada) · CRP Art. 32.º · CPP Art. 125.º' : 'Basis: RGIT Art. 103 (Tax Fraud) · Art. 104 (Qualified Fraud) · CRP Art. 32 · CPP Art. 125'}`, _termW / 2, y, {
				align: 'center'
			});
			doc.setTextColor(0, 0, 0);
		...
		const _afsSession = (typeof window.activeForensicSession !== 'undefined') ? window.activeForensicSession : null;
		const _sysMasterHash = (typeof UNIFEDSystem !== 'undefined') ? UNIFEDSystem.masterHash : null;
		const _mhCandidate = (_afsSession && _afsSession.masterHash) ? _afsSession.masterHash : _sysMasterHash;
		...
		if(!_mhCandidate || !_SHA256_RE.test(_mhCandidate)) {
			...
			if(typeof Swal !== 'undefined') {
				Swal.fire({
					...
					text: currentLang === 'en' ? 'The Master Hash has not been calculated. Please complete the evidence analysis cycle before exporting.' : 'O Master Hash não foi calculado. Complete o ciclo de análise de evidências antes de exportar.',
					confirmButtonColor: '#C0392B'
				});
			} else {
				alert(currentLang === 'en' ? 'Export blocked: Master Hash not calculated. Complete the analysis cycle first.' : 'Exportação bloqueada: Master Hash não calculado. Complete o ciclo de análise primeiro.');
			}
			return;
		}
		...
		for(let _p = 1; _p <= realTotalPages; _p++) {
			...
			doc.setFontSize(5.2);
			doc.setTextColor(100, 100, 100);
			doc.text(`${currentLang === 'pt' ? 'Master Hash SHA-256:' : 'Master Hash SHA-256:'} ${_mhFull}`, _pw - _mg, _ph - 14, {
				align: 'right'
			});
			doc.setFont('courier', 'normal');
			doc.setFontSize(5.5);
			doc.setTextColor(140, 140, 140);
			doc.text(`${currentLang === 'pt' ? 'UNIFED-PROBATUM v13.5.0-PURE · RECONSTITUIÇÃO DA VERDADE MATERIAL DIGITAL · Art. 125.º CPP' : 'UNIFED-PROBATUM v13.5.0-PURE · RECONSTRUCTION OF DIGITAL MATERIAL TRUTH · Art. 125 CPP'}`, _pw / 2, _ph - 9, {
				align: 'center'
			});
			doc.setDrawColor(0, 0, 0);
			doc.setTextColor(0, 0, 0);
		...
		ForensicLogger.addEntry('PDF_EXPORT_COMPLETED', {
			sessionId: UNIFEDSystem.sessionId,
			pages: realTotalPages,
			qrSealed: !!_qrDataUrl
		});
	} catch (error) {
		...
		ForensicLogger.addEntry('PDF_EXPORT_ERROR', {
			error: error.message
		});
	}
}
...
function processAuxiliaryPlatformData(text, filename) {
	...
	let gorjetas = 0;
	let cancelamentos = 0;
	const campaignMatch = text.match(/Ganhos\s+da\s+campa[nñ]ha\s*[:\-–]?\s*(?:€\s*)?([\d][.\d]*[,\d]*\s*€?)/i) || text.match(/Campaign\s+(?:earnings?|bonus)\s*[:\-–]?\s*(?:€\s*)?([\d][.\d]*[,\d]*\s*€?)/i);
	...
	if(portagens === 0) {
		const portageTextMatch = text.match(/(?:Portagens?|Reembolsos\s+de\s+despesas)\s*[:\-–]?\s*(?:€\s*)?([\d][.\d]*[,\d]*\s*€?)/i) || text.match(/Tolls?\s*[:\-–]?\s*(?:€\s*)?([\d][.\d]*[,\d]*\s*€?)/i);
		if(portageTextMatch && portageTextMatch[1]) {
			portagens = normalizeNumericValue(portageTextMatch[1]);
		}
	}
	const tipsMatch = text.match(/Gorjetas\s+dos\s+passageiros\s*[:\-–]?\s*(?:€\s*)?([\d][.\d]*[,\d]*\s*€?)/i) || text.match(/(?:Tips?|Gorjetas?)\s*[:\-–]?\s*(?:€\s*)?([\d][.\d]*[,\d]*\s*€?)/i);
	const cancelMatch = text.match(/Cancelamentos?\s*[:\-–]?\s*(?:€\s*)?([\d][.\d]*[,\d]*\s*€?)/i) || text.match(/(?:Cancel(?:lation)?\s+fees?)\s*[:\-–]?\s*(?:€\s*)?([\d][.\d]*[,\d]*\s*€?)/i);
	...
	UNIFEDSystem.auxiliaryData.totalNaoSujeitos = forensicRound(UNIFEDSystem.auxiliaryData.campanhas + UNIFEDSystem.auxiliaryData.portagens + UNIFEDSystem.auxiliaryData.gorjetas);
	...
	if(anyFound) {
		logAudit(`[AUX] ${filename || 'Extrato'} — ` + `${currentLang === 'pt' ? 'Campanhas:' : 'Campaigns:'} ${formatCurrency(campanhas)} | ` + `${currentLang === 'pt' ? 'Portagens:' : 'Tolls:'} ${formatCurrency(portagens)} | ` + `${currentLang === 'pt' ? 'Gorjetas:' : 'Tips:'} ${formatCurrency(gorjetas)} | ` + `${currentLang === 'pt' ? 'Cancelamentos:' : 'Cancellations:'} ${formatCurrency(cancelamentos)} | ` + `${currentLang === 'pt' ? 'Total Não Sujeitos:' : 'Total Not Subject:'} ${formatCurrency(UNIFEDSystem.auxiliaryData.totalNaoSujeitos)}`, 'success');
		...
		logAudit(`[AUX] ${filename || 'Extrato'} — ${currentLang === 'pt' ? 'Campos auxiliares não encontrados neste ficheiro.' : 'Auxiliary fields not found in this file.'}`, 'info');
	}
}
...
function generateMasterHash() {
	...
	const evidenceHashes = UNIFEDSystem.analysis.evidenceIntegrity.map(ev => ev.hash).filter(h => h && h.length === 64).sort();
...
function clearConsole() {
	...
	document.querySelectorAll('.led-red-blink, .led-yellow-blink').forEach(led => {
...
function resetAllValues() {
	...
	UNIFEDSystem.documents.statements.totals = {
		records: 0,
		ganhos: 0,
		despesas: 0,
		ganhosLiquidos: 0
	...
	UNIFEDSystem.documents.control.totals = {
		records: 0
	};
	...
	UNIFEDSystem.casoRealAnonimizado = false;
	if(UNIFEDSystem.fileSources) UNIFEDSystem.fileSources.clear();
	const elementsToReset = ['saftIliquidoValue', 'saftIvaValue', 'saftBrutoValue', 'stmtGanhosValue', 'stmtDespesasValue', 'stmtGanhosLiquidosValue', 'dac7Q1Value', 'dac7Q2Value', 'dac7Q3Value', 'dac7Q4Value', 'statNet', 'statComm', 'statJuros', 'kpiGrossValue', 'kpiCommValue', 'kpiNetValue', 'kpiInvValue', 'quantumValue', 'verdictLevel', 'verdictPercentValue', 'alertDeltaValue', 'discrepancy5Value', 'agravamentoBrutoValue', 'ircValue', 'iva6Value', 'iva23Value', 'revenueGapValue', 'expenseGapValue'];
...
function setupDualScreenDetection() {
	...
	document.addEventListener('keydown', (e) => {
		if(e.ctrlKey && e.shiftKey && e.key === 'P') {
			...
			ForensicLogger.addEntry('PRESENTATION_MODE_TOGGLED', {
				active: isActive
			});
		}
	});
...
(function() {
	window.addEventListener('load', () => {
		...
		if(UNIFEDSystem.documents?.saft?.totals?.bruto > 0 || UNIFEDSystem.analysis.evidenceIntegrity.length > 0) {

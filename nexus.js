...
(function _nexusCore() {
    ...
    // Pequeno helper para forçar a exibição dos módulos caso o evento não dispare
    window.forceRevealSmokingGun = function() {
        if (typeof window.performForensicAnalysis === 'function') {
            window.performForensicAnalysis();
        } else {
            console.warn('[NEXUS] performForensicAnalysis não disponível para forceReveal.');
        }
    };
